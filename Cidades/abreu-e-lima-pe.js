var cidadeDetalhe = {
  ...
  uf: 'PE',
  ibge: '2600054',
  constante: 'CodigoIBGE.AbreuELimaPE',
  provedorAtual: {
    nome: 'Tributus',
    namespace: 'http://tributosInformatica.com.br',
    codigoNoProvedor: 'UsaItemListaServico;UsaCNAE',
    robo: true,
    webService: false,
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'https://www.tributosmunicipais.com.br/NFE-abreuelima/',
        recepcaoLote: 'https://www.tributosmunicipais.com.br/NFE-abreuelima/'
      }
    }
  },
