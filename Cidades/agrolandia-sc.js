var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4200200',
  constante: 'CodigoIBGE.AgrolandiaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://agrolandia.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://agrolandia.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        cancelamentoNFe: 'https://agrolandia.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
