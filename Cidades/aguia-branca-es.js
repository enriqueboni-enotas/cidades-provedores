var cidadeDetalhe = {
  ...
  uf: 'ES',
  ibge: '3200136',
  constante: 'CodigoIBGE.AguiaBrancaES',
  provedorAtual: {
    nome: 'EeL',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://es-aguiabranca-pm-nfs.cloud.el.com.br/RpsService',
        consultaRps: 'https://es-aguiabranca-pm-nfs.cloud.el.com.br/'
      }
    }
  },
