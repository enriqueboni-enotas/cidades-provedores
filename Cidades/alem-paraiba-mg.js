var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3101508',
  constante: 'CodigoIBGE.AlemParaibaMG',
  provedorAtual: {
    nome: 'PortalFacil',
    namespace: 'http://nfse-mg-alemparaiba.portalfacil.com.br/nfseserv/schema/nfse_v202.xsd',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-mg-alemparaiba.portalfacil.com.br/homologacao/webservice/servicos.asmx'
      },
      producao: {
        recepcaoLote: 'https://nfse-mg-alemparaiba.portalfacil.com.br/nfseserv/webservice/servicos.asmx'
      }
    }
  },
