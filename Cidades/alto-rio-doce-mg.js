var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3102100',
  constante: 'CodigoIBGE.AltoRioDoceMG',
  provedorAtual: {
    nome: 'Futurize',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaCnae',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    urls: {
      homologacao: {
        recepcaoLote: 'https://altoriodocemg.nfse-futurize.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://altoriodocemg.nfse-futurize.com.br/webservice/prod'
      }
    }
  },
