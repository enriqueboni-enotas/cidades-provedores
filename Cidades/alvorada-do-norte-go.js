var cidadeDetalhe = {
  id: 'alvorada-do-norte-go',
  nome: 'Alvorada do Norte',
  uf: 'GO',
  ibge: '5200803',
  constante: 'CodigoIBGE.AlvoradaDoNorteGO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://alvoradadonorte.megasoftarrecadanet.com.br/alvoradadonorte/ws/nfseSOAP'
      }
    }
  },
