var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4300604',
  constante: 'CodigoIBGE.AlvoradaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://alvorada.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://alvorada.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        cancelamentoNFe: 'https://alvorada.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
