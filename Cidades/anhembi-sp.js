var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3502309',
  constante: 'CodigoIBGE.AnhembiSP',
  provedorAtual: {
    nome: 'GeisWeb',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://www.gerenciadecidades.com.br/producao/anhembi/webservice/GeisWebServiceImpl.php',
        downloadPDF: 'https://geisweb.net.br/anhembi/'
      }
    }
  },
