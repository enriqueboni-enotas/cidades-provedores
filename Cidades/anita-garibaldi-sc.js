var cidadeDetalhe = {
  id: 'anita-garibaldi-sc',
  nome: 'Anita Garibaldi',
  uf: 'SC',
  ibge: '4201000',
  constante: 'CodigoIBGE.AnitaGaribaldiSC',
  provedorAtual: {
    nome: 'IPMv2',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-anitagaribaldi.atende.net/?pg=services&service=WNENotaFiscalEletronicaNfe'
      },
      producao: {
        recepcaoLote: 'https://ws-anitagaribaldi.atende.net/?pg=services&service=WNENotaFiscalEletronicaNfe'
      }
