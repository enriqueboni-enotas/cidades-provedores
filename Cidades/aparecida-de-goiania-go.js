var cidadeDetalhe = {
  id: 'aparecida-de-goiania-go',
  nome: 'Aparecida de Goiânia',
  uf: 'GO',
  ibge: '5201405',
  constante: 'CodigoIBGE.AparecidaDeGoianiaGO',
  provedorAtual: {
    nome: 'NotaControl',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'CancelaEmHomologacao; REGRAPADRAOALIQUOTAABRASFV204',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.issnetonline.com.br/abrasf204/aparecidadegoiania/nfse.asmx'
      }
    }
  },
