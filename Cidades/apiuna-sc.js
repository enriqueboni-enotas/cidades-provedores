var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-apiuna.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-apiuna.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-apiuna.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
