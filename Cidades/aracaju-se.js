var cidadeDetalhe = {
  ...
  uf: 'SE',
  ibge: '2800308',
  constante: 'CodigoIBGE.AracajuSE',
  provedorAtual: {
    nome: 'WebISSv2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'EnviaAliquotaISSQNDevidoOutroMunicipioOuOptanteSimplesERetencaoISSQN; EnviaCodigoTributacaoEItemLista; NaoSuportaEmissaoClienteSemCpf',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://aracajuse.webiss.com.br/ws/nfse.asmx'
      }
    }
  },
