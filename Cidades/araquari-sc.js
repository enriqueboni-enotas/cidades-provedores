var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4201307',
  constante: 'CodigoIBGE.AraquariSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-araquari.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-araquari.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-araquari.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      }
    }
  },
