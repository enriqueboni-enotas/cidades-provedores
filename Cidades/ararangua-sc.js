var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4201406',
  constante: 'CodigoIBGE.AraranguaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-ararangua.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-ararangua.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-ararangua.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
