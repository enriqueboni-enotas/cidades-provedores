var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3503208',
  constante: 'CodigoIBGE.AraraquaraSP',
  provedorAtual: {
    nome: 'GIAPv2',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'https://araraquara.giap.com.br/ords/pma/f?p=616:101::::::',
        recepcaoLote: 'https://araraquara.giap.com.br/ords/pma/ws/nfe/emitir_nfe',
        consultaRps: 'https://qa.giap.com.br/ords/atpma/',
        consultaNFe: 'https://araraquara.giap.com.br/ords/pma/ws/nfe/consulta_nota',
        cancelamentoNFe: 'https://araraquara.giap.com.br/ords/pma/ws/nfe/cancelar_nota'
      }
    }
  },
