var cidadeDetalhe = {
  ...
  uf: 'PE',
  ibge: '2601102',
  constante: 'CodigoIBGE.AraripinaPE',
  provedorAtual: {
    nome: 'HM2',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://araripina.hm2solucoes.com.br/tributacao/RecepcionarLoteRps.rule?sys=TRB',
        consultaLote: 'https://araripina.hm2solucoes.com.br/tributacao/ConsultarNfsePorRps.rule?sys=TRB',
        cancelamentoNFe: 'https://araripina.hm2solucoes.com.br/tributacao/CancelarNfse.rule?sys=TRB'
      }
    }
  },
