var cidadeDetalhe = {
  ...
  uf: 'RO',
  ibge: '1100023',
  constante: 'CodigoIBGE.AriquemesRO',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaProxy, UsaCodigoServicoMunicipal; UsaCidadePrestacaoParaCancelamento; UsaClasseSubstituirNfse',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.ariquemes.ro.gov.br/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
