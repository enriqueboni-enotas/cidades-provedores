var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4201703',
  constante: 'CodigoIBGE.AscurraSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-ascurra.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-ascurra.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-ascurra.atende.net/?pg=rest&service=WNERestServiceNFSe',
