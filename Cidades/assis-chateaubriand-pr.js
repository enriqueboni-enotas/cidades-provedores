var cidadeDetalhe = {
  id: 'assis-chateaubriand-pr',
  nome: 'Assis Chateaubriand',
  uf: 'PR',
  ibge: '4102000',
  constante: 'CodigoIBGE.AssisChateaubriandPR',
  provedorAtual: {
    nome: 'GOVBR',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://assischateaubriand.govbr.cloud/NFSe.Portal.Integracao/Services.svc'
      }
    }
  },
