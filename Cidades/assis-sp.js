var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3504008',
  constante: 'CodigoIBGE.AssisSP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaProxy, UsaCodigoServicoMunicipal, UsaCNAE, UsaExigibilidadeIssUm, EnviaValorIssZerado, NaoSuportaCancelamento',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfsews.assis.sp.gov.br/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
