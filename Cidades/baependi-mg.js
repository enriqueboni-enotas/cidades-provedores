var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3104908',
  constante: 'CodigoIBGE.BaependiMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://baependimg.futurize-nfse.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://baependimg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
