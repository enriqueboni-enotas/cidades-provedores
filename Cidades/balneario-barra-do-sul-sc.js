var cidadeDetalhe = {
  id: 'balneario-barra-do-sul-sc',
  nome: 'Balneário Barra do Sul',
  uf: 'SC',
  ibge: '4202057',
  constante: 'CodigoIBGE.BalnearioBarraDoSulSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaItemListaServico;EnviaCodigoAtividade',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://balneariobarradosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://balneariobarradosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://balneariobarradosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
