var cidadeDetalhe = {
  id: 'balneario-picarras-sc',
  nome: 'Balneário Piçarras',
  uf: 'SC',
  ibge: '4212809',
  constante: 'CodigoIBGE.BalnearioPicarrasSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://balneariopicarras.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://balneariopicarras.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://balneariopicarras.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
