var cidadeDetalhe = {
  ...
  uf: 'CE',
  ibge: '2301901',
  constante: 'CodigoIBGE.BarbalhaCE',
  provedorAtual: {
    nome: 'SpeedGov',
    namespace: null,
    codigoNoProvedor: 'UsaSoap11;UsaProxy',
    robo: false,
    webService: true,
    versaoAbrasf: '1.01',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://speedgov.com.br/wsbar/Nfes'
      }
    },
    emissaoSemCertificado: {
      producao: 'https://iss.speedgov.com.br/barbalha'
    }
  },
