var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4202107',
  constante: 'CodigoIBGE.BarraVelhaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://barravelha.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://barravelha.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://barravelha.atende.net/?pg=rest&service=WNERestServiceNFSe',
