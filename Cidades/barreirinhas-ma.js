var cidadeDetalhe = {
  ...
  uf: 'MA',
  ibge: '2101707',
  constante: 'CodigoIBGE.BarreirinhasMA',
  provedorAtual: {
    nome: 'SpeedGovV2',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://tributario.speedgov.com.br/barreirinhas/api/v1/nfse/v101',
        cancelamentoNFe: 'https://tributario.speedgov.com.br/barreirinhas/api/v1/nfse',
        downloadPDF: 'https://tributario.speedgov.com.br/barreirinhas/api/v1/danfse'
      }
    },
