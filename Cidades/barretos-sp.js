var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3505500',
  constante: 'CodigoIBGE.BarretosSP',
  provedorAtual: {
    nome: 'RLZv3',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://barretos.prefeitura.rlz.com.br/nota/nacional/nfse'
      },
      producao: {
        recepcaoLote: 'https://cidadaoonline.barretos.sp.gov.br/nota/nacional/nfse',
