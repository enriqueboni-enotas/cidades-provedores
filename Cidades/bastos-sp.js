var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3505807',
  constante: 'CodigoIBGE.BastosSP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaCodigoServicoMunicipal;NaoUsaAssinatura;NaoSuportaCancelamento',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://bastossp.dcfiorilli.com.br:8090/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
