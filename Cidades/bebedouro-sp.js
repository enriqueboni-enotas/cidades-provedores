var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3506102',
  constante: 'CodigoIBGE.BebedouroSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.bebedouro/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.bebedouro/webservice/aws_nfe.aspx'
      }
    }
  },
