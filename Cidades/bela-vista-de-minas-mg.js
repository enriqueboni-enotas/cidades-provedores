var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3106002',
  constante: 'CodigoIBGE.BelaVistaDeMinasMG',
  provedorAtual: {
    nome: 'eReceita',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ws/belavistademinasmg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/belavistademinasmg/wsProducao.php'
      }
    }
  },
