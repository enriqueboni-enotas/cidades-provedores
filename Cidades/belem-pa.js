var cidadeDetalhe = {
  ...
  uf: 'PA',
  ibge: '1501402',
  constante: 'CodigoIBGE.BelemPA',
  provedorAtual: {
    nome: 'DSFv2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoPermiteCancelamento',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://sefin-hml.belem.pa.gov.br/notafiscal-abrasfv203-ws/NotaFiscalSoap'
      },
      producao: {
        recepcaoLote: 'https://notafiscal.belem.pa.gov.br/notafiscal-abrasfv203-ws/NotaFiscalSoap'
      }
    }
  },
