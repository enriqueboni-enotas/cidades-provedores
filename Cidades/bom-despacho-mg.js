var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3107406',
  constante: 'CodigoIBGE.BomDespachoMG',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-bomdespacho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ws-bomdespacho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://ws-bomdespacho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        cancelamentoNFe: 'https://ws-bomdespacho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
