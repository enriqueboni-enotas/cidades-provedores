var cidadeDetalhe = {
  id: 'bom-jardim-de-minas-mg',
  nome: 'Bom Jardim de Minas',
  uf: 'MG',
  ibge: '3107505',
  constante: 'CodigoIBGE.BomJardimDeMinasMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://bomjardimdeminasmg.nfse-futurize.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://bomjardimdeminasmg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
