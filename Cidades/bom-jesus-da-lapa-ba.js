var cidadeDetalhe = {
  id: 'bom-jesus-da-lapa-ba',
  nome: 'Bom Jesus da Lapa',
  uf: 'BA',
  ibge: '2903904',
  constante: 'CodigoIBGE.BomJesusDaLapaBA',
  provedorAtual: {
    nome: 'Saatri',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologa-bjlapa.saatri.com.br/servicos/nfse.svc'
      },
      producao: {
        recepcaoLote: 'https://bjlapa.saatri.com.br/servicos/nfse.svc'
      }
    }
  },
