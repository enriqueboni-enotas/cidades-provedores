var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4202602',
  constante: 'CodigoIBGE.BomRetiroSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaISO88591Envio',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        autenticacao: 'http://sync.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_login.php',
        recepcaoLote: 'http://sync.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_upload.php?eletron=1',
        cancelamentoNFe: 'http://sync.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_upload.php?eletron=1',
