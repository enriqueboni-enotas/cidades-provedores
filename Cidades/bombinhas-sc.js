var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4202453',
  constante: 'CodigoIBGE.BombinhasSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'EnviaCodigoAtividade;EnviarAliquota4CasasDecimais;UsaItemListaServico',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://bombinhas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://bombinhas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://bombinhas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
