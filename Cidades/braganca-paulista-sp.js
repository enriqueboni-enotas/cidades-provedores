var cidadeDetalhe = {
  id: 'braganca-paulista-sp',
  nome: 'Bragança Paulista',
  uf: 'SP',
  ibge: '3507605',
  constante: 'CodigoIBGE.BragancaPaulistaSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.bragancapaulista/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.bragancapaulista/webservice/aws_nfe.aspx'
      }
    }
  },
  configuracaoProvedor: {
    ...
    helpAEDF: 'Informe aqui o código de serviço municipal que identifica o serviço prestado na nota fiscal. \r\n\r\nEle possui geralmente 5 dígitos formatado com um ponto.\r\nExemplos válidos: 08.02 e 17.01',
