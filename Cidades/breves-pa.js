var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://breves.homologacao.isaneto.com.br:8080/erp-prefeitura-ejb/nfse'
      },
      producao: {
        recepcaoLote: 'http://breves.isaneto.com.br:8080/erp-prefeitura-ejb/nfse'
      }
    }
  },
