var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3508405',
  constante: 'CodigoIBGE.CabreuvaSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.cabreuva/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.cabreuva/webservice/aws_nfe.aspx'
      }
    }
  },
