var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3508504',
  constante: 'CodigoIBGE.CacapavaSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.cacapava/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.cacapava/webservice/aws_nfe.aspx'
      }
    }
  },
