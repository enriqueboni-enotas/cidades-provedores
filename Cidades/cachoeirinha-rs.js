var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4303103',
  constante: 'CodigoIBGE.CachoeirinhaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'EnviarAliquota4CasasDecimais;RequerAssinatura;UsaAutenticidadeNota',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://cachoeirinha.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://cachoeirinha.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://cachoeirinha.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
