var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3509007',
  constante: 'CodigoIBGE.CaieirasSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.caieiras/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.caieiras/webservice/aws_nfe.aspx'
      }
    }
  },
