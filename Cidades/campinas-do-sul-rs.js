var cidadeDetalhe = {
  id: 'campinas-do-sul-rs',
  nome: 'Campinas do Sul',
  uf: 'RS',
  ibge: '4303806',
  constante: 'CodigoIBGE.CampinasDoSulRS',
  provedorAtual: {
    nome: 'SystemPro',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sistema.campinasdosul.rs.gov.br:8183/NfseService_Homolog/NfseService_Homolog'
      },
      producao: {
        recepcaoLote: 'https://sistema.campinasdosul.rs.gov.br:8182/NfseService/NfseService'
      }
    }
  },
