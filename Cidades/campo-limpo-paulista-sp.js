var cidadeDetalhe = {
  id: 'campo-limpo-paulista-sp',
  nome: 'Campo Limpo Paulista',
  uf: 'SP',
  ibge: '3509601',
  constante: 'CodigoIBGE.CampoLimpoPaulistaSP',
  provedorAtual: {
    nome: 'GeisWeb',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://www.gerenciadecidades.com.br/producao/campolimpopaulista/webservice/GeisWebServiceImpl.php',
        downloadPDF: 'https://geisweb.net.br/campolimpopaulista/'
      }
    }
  },
