var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4104303',
  constante: 'CodigoIBGE.CampoMouraoPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://campomourao.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://campomourao.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://campomourao.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
