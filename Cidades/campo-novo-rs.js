var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4304002',
  constante: 'CodigoIBGE.CampoNovoRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'http://sync-rs.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_login.php',
        recepcaoLote: 'http://sync-rs.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_upload.php?eletron=1',
        cancelamentoNFe: 'http://sync-rs.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_upload.php?eletron=1',
