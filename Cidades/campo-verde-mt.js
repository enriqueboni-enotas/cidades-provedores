var cidadeDetalhe = {
  ...
  uf: 'MT',
  ibge: '5102678',
  constante: 'CodigoIBGE.CampoVerdeMT',
  provedorAtual: {
    nome: 'CoplanV2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoSuportaEmissaoClienteSemCpf; NaoSuportaEmissaoSemCliente; NaoSuportaEmissaoClienteSemEndereco',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://www.gp.srv.br/tributario/campoverde/anfse_ws'
      }
    },
