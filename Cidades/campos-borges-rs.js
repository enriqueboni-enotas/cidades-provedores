var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4304101',
  constante: 'CodigoIBGE.CamposBorgesRS',
  provedorAtual: {
    nome: 'SIMv2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sim.digifred.net.br/camposborges_homolog/nfse/ws/principal'
      },
      producao: {
        recepcaoLote: 'https://sim.digifred.net.br/camposborges/nfse/ws/principal'
      }
    }
  },
