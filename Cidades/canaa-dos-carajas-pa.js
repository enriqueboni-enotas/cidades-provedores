var cidadeDetalhe = {
  id: 'canaa-dos-carajas-pa',
  nome: 'Canaã dos Carajás',
  uf: 'PA',
  ibge: '1502152',
  constante: 'CodigoIBGE.CanaaDosCarajasPA',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaCodigoServicoMunicipal',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://tributario.canaadoscarajas.pa.gov.br:8080/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
