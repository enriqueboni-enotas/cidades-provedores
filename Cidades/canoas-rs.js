var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://canoas-homol.infisc.com.br/services/nfse/ws/Servicos'
      },
      producao: {
        recepcaoLote: 'https://nfse.canoas.rs.gov.br/services/nfse/ws/Servicos'
      }
    }
  },
