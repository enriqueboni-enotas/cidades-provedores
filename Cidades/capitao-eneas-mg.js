var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3112703',
  constante: 'CodigoIBGE.CapitaoEneasMG',
  provedorAtual: {
    nome: 'Sintese',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaCustomBiding;NaoSuportaEmissaoSemTomador;UsaCnae;UsaItemListaServico',
    robo: false,
    webService: true,
    versaoAbrasf: '2.01',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://capitaoeneas.sintesetecnologia.com.br/nfsews/NfseWS'
      }
    }
  },
