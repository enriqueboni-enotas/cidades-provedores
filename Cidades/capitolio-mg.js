var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3112802',
  constante: 'CodigoIBGE.CapitolioMG',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaProxy; UsaClasseSubstituirNfse',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://capitolio2-web.sigmix.net/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
