var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4104659',
  constante: 'CodigoIBGE.CarambeiPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-carambei.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-carambei.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-carambei.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      }
    }
  },
