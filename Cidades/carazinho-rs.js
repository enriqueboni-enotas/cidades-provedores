var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4304705',
  constante: 'CodigoIBGE.CarazinhoRS',
  provedorAtual: {
    nome: 'IPMv2',
    namespace: null,
    codigoNoProvedor: 'UsaIPMv2WSv2;NaoUtilizaCodigoServicoMunicipal',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://carazinho.atende.net/?pg=services&service=WNENotaFiscalEletronicaNfe'
      },
      producao: {
        recepcaoLote: 'https://carazinho.atende.net/?pg=services&service=WNENotaFiscalEletronicaNfe'
      }
