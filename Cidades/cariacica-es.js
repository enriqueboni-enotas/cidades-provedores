var cidadeDetalhe = {
  ...
  uf: 'ES',
  ibge: '3201308',
  constante: 'CodigoIBGE.CariacicaES',
  provedorAtual: {
    nome: 'SILv4',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologtributacao.cariacica.es.gov.br/tbw/services/NotaFiscalNacional',
      ...
      producao: {
        recepcaoLote: 'https://sistemas.cariacica.es.gov.br/tbw/services/NotaFiscalNacional',
