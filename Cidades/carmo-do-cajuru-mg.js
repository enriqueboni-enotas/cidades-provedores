var cidadeDetalhe = {
  id: 'carmo-do-cajuru-mg',
  nome: 'Carmo do Cajuru',
  uf: 'MG',
  ibge: '3114204',
  constante: 'CodigoIBGE.CarmoDoCajuruMG',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-carmodocajuru.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://nfse-carmodocajuru.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://nfse-carmodocajuru.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
