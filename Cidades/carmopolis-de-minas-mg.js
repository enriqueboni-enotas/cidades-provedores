var cidadeDetalhe = {
  id: 'carmopolis-de-minas-mg',
  nome: 'Carmópolis de Minas',
  uf: 'MG',
  ibge: '3114501',
  constante: 'CodigoIBGE.CarmopolisDeMinasMG',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaItemListaServico',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-carmopolisdeminas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-carmopolisdeminas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-carmopolisdeminas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
