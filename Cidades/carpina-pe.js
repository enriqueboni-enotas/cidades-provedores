var cidadeDetalhe = {
  ...
  uf: 'PE',
  ibge: '2604007',
  constante: 'CodigoIBGE.CarpinaPE',
  provedorAtual: {
    nome: 'HM2',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://carpina.hm2solucoes.com.br/tributacao/RecepcionarLoteRps.rule?sys=TRB',
        consultaLote: 'https://carpina.hm2solucoes.com.br/tributacao/ConsultarNfsePorRps.rule?sys=TRB',
        cancelamentoNFe: 'https://carpina.hm2solucoes.com.br/tributacao/CancelarNfse.rule?sys=TRB'
      }
    }
  },
