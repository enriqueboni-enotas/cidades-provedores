var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4104808',
  constante: 'CodigoIBGE.CascavelPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'ValidaCpfCnpjTomador;NaoSuportaCancelarNFe;UsaAutenticidadeNota;UsaEnderecoInformado',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-cascavel.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-cascavel.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-cascavel.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
