var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4104907',
  constante: 'CodigoIBGE.CastroPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'NaoSuportaEmissaoNFeClienteSemCpf',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://castro.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://castro.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://castro.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
