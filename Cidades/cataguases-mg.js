var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3115300',
  constante: 'CodigoIBGE.CataguasesMG',
  provedorAtual: {
    nome: 'VersaTecnologia',
    namespace: 'https://nfse.cataguases.mg.gov.br/webservices/2.04/nfse_v204.xsd',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.cataguases.mg.gov.br/webservices/2.04/servicos'
      }
    }
  },
