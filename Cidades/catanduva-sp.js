var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3511102',
  constante: 'CodigoIBGE.CatanduvaSP',
  provedorAtual: {
    nome: 'RLZv3',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://catanduva.prefeitura.rlz.com.br/nota/nacional/nfse'
      },
      producao: {
        recepcaoLote: 'https://cidadaoonline.catanduva.sp.gov.br/nota/nacional/nfse',
