var cidadeDetalhe = {
  ...
  uf: 'MA',
  ibge: '2103208',
  constante: 'CodigoIBGE.ChapadinhaMA',
  provedorAtual: {
    nome: 'PowerSistemas',
    namespace: 'http://nfse.portalpublico.net/schema/nfse_v202.xsd',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse.portalpublico.net/homologacao/webservice/servicos'
      },
      producao: {
        recepcaoLote: 'https://nfse.portalpublico.net/chapadinha/webservice/servicos'
      }
    }
  },
