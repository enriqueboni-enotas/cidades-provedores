var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4105607',
  constante: 'CodigoIBGE.CidadeGauchaPR',
  provedorAtual: {
    nome: 'GOVBR',
    namespace: null,
    codigoNoProvedor: 'NaoEnviaValorIssRetido;UsaDocumentoTomadorExterior',
    robo: false,
    webService: true,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://cidadegaucha.govbr.cloud/NFSe.Portal.Integracao/Services.svc'
      }
    }
  },
