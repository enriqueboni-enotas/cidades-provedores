var cidadeDetalhe = {
  id: 'claro-dos-pocoes-mg',
  nome: 'Claro dos Poções',
  uf: 'MG',
  ibge: '3116506',
  constante: 'CodigoIBGE.ClaroDosPocoesMG',
  provedorAtual: {
    nome: 'DBSeller',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://nfeclarodospocoes.contassconsultoria.com.br/webservice/index/homologacao'
      },
      producao: {
        recepcaoLote: 'http://nfeclarodospocoes.contassconsultoria.com.br/webservice/index/producao'
      }
    }
  },
