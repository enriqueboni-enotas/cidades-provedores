var cidadeDetalhe = {
  id: 'colorado-do-oeste-ro',
  nome: 'Colorado do Oeste',
  uf: 'RO',
  ibge: '1100064',
  constante: 'CodigoIBGE.ColoradoDoOesteRO',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UseRotatingProxy',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://iss.coloradodooeste.ro.gov.br/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
