var cidadeDetalhe = {
  id: 'conceicao-do-mato-dentro-mg',
  nome: 'Conceição do Mato Dentro',
  uf: 'MG',
  ibge: '3117504',
  constante: 'CodigoIBGE.ConceicaoDoMatoDentroMG',
  provedorAtual: {
    nome: 'GovDigital',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.homolog.nfe-cidades.com.br/ws/cmatodentro'
      },
      producao: {
        recepcaoLote: 'https://ws.nfe-cidades.com.br/ws/cmatodentro'
      }
    }
  },
