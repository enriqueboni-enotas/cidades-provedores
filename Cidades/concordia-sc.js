var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4204301',
  constante: 'CodigoIBGE.ConcordiaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://concordia.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://concordia.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://concordia.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
