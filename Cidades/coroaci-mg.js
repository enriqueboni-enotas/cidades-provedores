var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3119203',
  constante: 'CodigoIBGE.CoroaciMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://coroacimg.nfse-futurize.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://coroacimg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
