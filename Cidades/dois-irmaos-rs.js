var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4306403',
  constante: 'CodigoIBGE.DoisIrmaosRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'NaoPermiteEmissaoRetroativa',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-doisirmaos.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-doisirmaos.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-doisirmaos.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
