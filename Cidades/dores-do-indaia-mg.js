var cidadeDetalhe = {
  id: 'dores-do-indaia-mg',
  nome: 'Dores do Indaiá',
  uf: 'MG',
  ibge: '3123205',
  constante: 'CodigoIBGE.DoresDoIndaiaMG',
  provedorAtual: {
    nome: 'GovDigital',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.homolog.nfe-cidades.com.br/ws/dores'
      },
      producao: {
        recepcaoLote: 'https://ws.nfe-cidades.com.br/ws/dores'
      }
    }
  },
