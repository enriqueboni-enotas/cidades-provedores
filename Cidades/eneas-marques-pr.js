var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4107405',
  constante: 'CodigoIBGE.EneasMarquesPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://eneasmarques.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://eneasmarques.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://eneasmarques.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
