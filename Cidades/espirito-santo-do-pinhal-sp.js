var cidadeDetalhe = {
  id: 'espirito-santo-do-pinhal-sp',
  nome: 'Espírito Santo do Pinhal',
  uf: 'SP',
  ibge: '3515186',
  constante: 'CodigoIBGE.EspiritoSantoDoPinhalSP',
  provedorAtual: {
    nome: 'Simpliss',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://wsespiritosantodopinhal.simplissweb.com.br/nfseservice.svc'
      }
    }
  },
