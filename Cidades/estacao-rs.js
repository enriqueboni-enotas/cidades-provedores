var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4307559',
  constante: 'CodigoIBGE.EstacaoRS',
  provedorAtual: {
    nome: 'SystemPro',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sistema.pmestacao.rs.gov.br:8183/NfseService_Homolog/NfseService_Homolog'
      },
      producao: {
        recepcaoLote: 'https://sistema.pmestacao.rs.gov.br:8182/NfseService/NfseService'
      }
    }
  },
