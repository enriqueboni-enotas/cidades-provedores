var cidadeDetalhe = {
  id: 'estancia-velha-rs',
  nome: 'Estância Velha',
  uf: 'RS',
  ibge: '4307609',
  constante: 'CodigoIBGE.EstanciaVelhaRS',
  provedorAtual: {
    nome: 'IPMv2',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-estanciavelha.atende.net//?pg=services&service=WNENotaFiscalEletronicaNfe'
      },
      producao: {
        recepcaoLote: 'https://estanciavelha.atende.net/?pg=services&service=WNENotaFiscalEletronicaNfe'
      }
    }
  },
