var cidadeDetalhe = {
  id: 'euclides-da-cunha-paulista-sp',
  nome: 'Euclides da Cunha Paulista',
  uf: 'SP',
  ibge: '3515350',
  constante: 'CodigoIBGE.EuclidesDaCunhaPaulistaSP',
  provedorAtual: {
    nome: 'GOVBRv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://webapp1-euclidesdacunhapaulista.cidade360.cloud/Nfse.Api/NotaNacional',
