var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3124906',
  constante: 'CodigoIBGE.EugenopolisMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://eugenopolismg.futurize-nfse.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://eugenopolismg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
