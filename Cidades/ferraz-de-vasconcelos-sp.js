var cidadeDetalhe = {
  id: 'ferraz-de-vasconcelos-sp',
  nome: 'Ferraz de Vasconcelos',
  uf: 'SP',
  ibge: '3515707',
  constante: 'CodigoIBGE.FerrazDeVasconcelosSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.ferraz/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.ferraz/webservice/aws_nfe.aspx'
      }
    }
  },
