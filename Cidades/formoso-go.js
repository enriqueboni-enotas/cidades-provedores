var cidadeDetalhe = {
  ...
  uf: 'GO',
  ibge: '5208103',
  constante: 'CodigoIBGE.FormosoGO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    namespace: 'http://megasoftarrecadanet.com.br/xsd/nfse_v01.xsd',
    codigoNoProvedor: 'NaoSuportaEmissaoSemCliente;NaoSuportaEmissaoNfeClienteSemEndereco;NaoUtilizaResponsavelRetencao;UsaDocumentoTomadorExterior',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://formoso.megasoftarrecadanet.com.br/formoso/ws/nfseSOAP'
      }
    }
  },
