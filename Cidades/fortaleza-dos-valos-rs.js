var cidadeDetalhe = {
  id: 'fortaleza-dos-valos-rs',
  nome: 'Fortaleza dos Valos',
  uf: 'RS',
  ibge: '4308458',
  constante: 'CodigoIBGE.FortalezaDosValosRS',
  provedorAtual: {
    nome: 'SIMv2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sim.digifred.net.br/fortalezadosvalos_homolog/nfse/ws/principal'
      },
      producao: {
        recepcaoLote: 'https://sim.digifred.net.br/fortalezadosvalos/nfse/ws/principal'
      }
    }
  },
