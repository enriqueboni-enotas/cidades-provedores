var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologacao.siltecnologia.com.br/tbfranca/services/NotaFiscalNacional',
      ...
      producao: {
        recepcaoLote: 'https://franca.siltecnologia.com.br/services/NotaFiscalNacional',
