var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4205704',
  constante: 'CodigoIBGE.GaropabaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://garopaba.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://garopaba.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://garopaba.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
