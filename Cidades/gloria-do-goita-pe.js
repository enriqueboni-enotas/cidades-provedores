var cidadeDetalhe = {
  id: 'gloria-do-goita-pe',
  nome: 'Glória do Goitá',
  uf: 'PE',
  ibge: '2606101',
  constante: 'CodigoIBGE.GloriaDoGoitaPE',
  provedorAtual: {
    nome: 'Tributus',
    namespace: 'http://tributosInformatica.com.br',
    codigoNoProvedor: 'EnviaParametroTributacaoServicoSelecionada',
    robo: true,
    webService: false,
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'https://www.tributosmunicipais.com.br/NFE-gloriadogoita/',
        recepcaoLote: 'https://www.tributosmunicipais.com.br/NFE-gloriadogoita/'
      }
    }
  },
