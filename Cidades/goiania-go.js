var cidadeDetalhe = {
  ...
  uf: 'GO',
  ibge: '5208707',
  constante: 'CodigoIBGE.GoianiaGO',
  provedorAtual: {
    nome: 'NotaControl',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'REGRAPADRAOALIQUOTAABRASFV204; NaoEnviaAliquotaZerada; UsaNatureza1IssRetidoFonte; SEMREGRAESPECIFICAHOMOLOGACAO',
    robo: false,
    webService: true,
    versaoAbrasf: '2.04',
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.issnetonline.com.br/abrasf204/goiania/nfse.asmx'
      }
    }
  },
