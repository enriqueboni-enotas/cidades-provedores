var cidadeDetalhe = {
  id: 'governador-nunes-freire-ma',
  nome: 'Governador Nunes Freire',
  uf: 'MA',
  ibge: '2104677',
  constante: 'CodigoIBGE.GovernadorNunesFreireMA',
  provedorAtual: {
    nome: 'PortalFacil',
    namespace: 'http://ws.oportaltributario.com.br/governadornunesfreire/schema/nfse_v202.xsd',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.oportaltributario.com.br/governadornunesfreire/homologacao/servicos'
      },
      producao: {
        recepcaoLote: 'https://ws.oportaltributario.com.br/governadornunesfreire/servicos'
      }
    }
  },
