var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4108700',
  constante: 'CodigoIBGE.GrandesRiosPR',
  provedorAtual: {
    nome: 'Elotech',
    namespace: 'http://shad.elotech.com.br/schemas/iss/nfse_v2_03.xsd',
    codigoNoProvedor: 'FormataCodigoPaisTomador; EnviaValorIssNull',
    robo: false,
    webService: true,
    versaoAbrasf: '2.03',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://grandesrios.oxy.elotech.com.br/iss-ws/nfse203.wsdl'
      }
    }
  },
