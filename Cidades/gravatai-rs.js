var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4309209',
  constante: 'CodigoIBGE.GravataiRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaDataFatoGerador',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://gravatai.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://gravatai.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://gravatai.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
