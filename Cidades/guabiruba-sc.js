var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4206306',
  constante: 'CodigoIBGE.GuabirubaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-guabiruba.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-guabiruba.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-guabiruba.atende.net/?pg=rest&service=WNERestServiceNFSe',
