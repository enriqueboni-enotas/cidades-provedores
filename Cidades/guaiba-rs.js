var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4309308',
  constante: 'CodigoIBGE.GuaibaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaItemListaServico;EnviaCodigoAtividade;UsaUnidadeServico5;NaoSuportaCancelarNFe',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://guaiba.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://guaiba.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://guaiba.atende.net/?pg=rest&service=WNERestServiceNFSe',
