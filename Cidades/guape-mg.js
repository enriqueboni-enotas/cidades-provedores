var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ereceita/rpp/ws/guapemg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/guapemg/wsProducao.php'
      }
    }
  },
