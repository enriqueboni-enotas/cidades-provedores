var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4206504',
  constante: 'CodigoIBGE.GuaramirimSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-guaramirim.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-guaramirim.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-guaramirim.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
