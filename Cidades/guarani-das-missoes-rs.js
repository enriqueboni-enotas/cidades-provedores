var cidadeDetalhe = {
  id: 'guarani-das-missoes-rs',
  nome: 'Guarani das Missões',
  uf: 'RS',
  ibge: '4309506',
  constante: 'CodigoIBGE.GuaraniDasMissoesRS',
  provedorAtual: {
    nome: 'GOVBRv3',
    namespace: 'http://www.sped.fazenda.gov.br/nfse',
    codigoNoProvedor: 'UsaAbrasf203;NaoPermiteCancelamento',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://webapp1-guaranidasmissoes.cidade360.cloud/NFSe.Api/NotaNacional',
