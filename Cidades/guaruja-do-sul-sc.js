var cidadeDetalhe = {
  id: 'guaruja-do-sul-sc',
  nome: 'Guarujá do Sul',
  uf: 'SC',
  ibge: '4206603',
  constante: 'CodigoIBGE.GuarujaDoSulSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-guarujadosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-guarujadosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-guarujadosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
