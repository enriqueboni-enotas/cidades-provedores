var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3129301',
  constante: 'CodigoIBGE.IapuMG',
  provedorAtual: {
    nome: 'VersaTecnologia',
    namespace: 'https://nfe.iapu.mg.gov.br/webservices/2.04/nfse_v204.xsd',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfe.iapu.mg.gov.br/webservices/2.04/servicos'
      }
    }
  },
