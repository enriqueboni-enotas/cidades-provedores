var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4206900',
  constante: 'CodigoIBGE.IbiramaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-ibirama.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-ibirama.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-ibirama.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
