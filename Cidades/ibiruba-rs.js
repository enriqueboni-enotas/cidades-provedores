var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4310009',
  constante: 'CodigoIBGE.IbirubaRS',
  provedorAtual: {
    nome: 'SIMv2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sim.digifred.net.br/ibiruba_homolog/nfse/ws/principal'
      },
      producao: {
        recepcaoLote: 'https://sim.digifred.net.br/ibiruba/nfse/ws/principal'
      }
    }
  },
