var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3130101',
  constante: 'CodigoIBGE.IgarapeMG',
  provedorAtual: {
    nome: 'QuasarV2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://igarape.mg.des.issqn.quasar.tec.br/nfe/snissdigitalsvc',
        downloadPDF: 'https://adn.nfse.gov.br/danfse'
      },
      producao: {
        recepcaoLote: 'https://igarape.mg.issqn.quasar.srv.br/nfe/snissdigitalsvc'
      }
    },
