var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4310108',
  constante: 'CodigoIBGE.IgrejinhaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-igrejinha.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-igrejinha.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-igrejinha.atende.net/?pg=rest&service=WNERestServiceNFSe',
