var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3520442',
  constante: 'CodigoIBGE.IlhaSolteiraSP',
  provedorAtual: {
    nome: 'RLZv3',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ilhasolteira.prefeitura.rlz.com.br/nota/nacional/nfse'
      },
      producao: {
        recepcaoLote: 'https://cidadaoonline.ilhasolteira.sp.gov.br/nota/nacional/nfse',
