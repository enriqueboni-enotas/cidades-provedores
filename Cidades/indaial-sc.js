var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4207502',
  constante: 'CodigoIBGE.IndaialSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-indaial.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-indaial.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-indaial.atende.net/?pg=rest&service=WNERestServiceNFSe',
