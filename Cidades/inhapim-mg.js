var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3130903',
  constante: 'CodigoIBGE.InhapimMG',
  provedorAtual: {
    nome: 'VersaTecnologia',
    namespace: 'https://nfe.inhapim.mg.gov.br/webservices/2.04/nfse_v204.xsd',
    codigoNoProvedor: 'NaoSuportaTomadorExterior',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://nfe.inhapim.mg.gov.br/webservices/2.04/servicos'
      }
    }
  },
