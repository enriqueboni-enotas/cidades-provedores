var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3131307',
  constante: 'CodigoIBGE.IpatingaMG',
  provedorAtual: {
    nome: 'SIGISSv5',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'ExigibilidadeISS1',
    robo: false,
    webService: true,
    versaoAbrasf: '2.04',
    urls: {
      homologacao: {
        recepcaoLote: 'https://testeipatinga.meumunicipio.online/abrasf/ws'
      },
      producao: {
        recepcaoLote: 'https://abrasfipatinga.meumunicipio.online/ws'
      }
    }
  },
