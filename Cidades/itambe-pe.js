var cidadeDetalhe = {
  ...
  uf: 'PE',
  ibge: '2607653',
  constante: 'CodigoIBGE.ItambePE',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoUsaAssinatura; NaoEnviaValorIss',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://gestao.cegep.inf.br:8107/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
