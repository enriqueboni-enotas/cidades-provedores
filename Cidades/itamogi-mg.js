var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3132909',
  constante: 'CodigoIBGE.ItamogiMG',
  provedorAtual: {
    nome: 'eReceita',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ws/itamogimg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/itamogimg/wsProducao.php'
      }
    }
  },
