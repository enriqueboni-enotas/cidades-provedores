var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3522406',
  constante: 'CodigoIBGE.ItapevaSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    codigoNoProvedor: 'SuporteEmissaoSemTomador',
    robo: false,
    webService: true,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.itapeva/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.itapeva/webservice/aws_nfe.aspx'
      }
    }
  },
