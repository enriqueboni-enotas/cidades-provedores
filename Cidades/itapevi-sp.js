var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3522505',
  constante: 'CodigoIBGE.ItapeviSP',
  provedorAtual: {
    nome: 'SILv4',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologacao.siltecnologia.com.br/tbitapevi/services/NotaFiscalNacional',
      ...
      producao: {
        recepcaoLote: 'https://itapevi.siltecnologia.com.br/services/NotaFiscalNacional',
