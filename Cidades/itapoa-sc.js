var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4208450',
  constante: 'CodigoIBGE.ItapoaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaItemListaServico;EnviaCodigoAtividade;UsaAutenticidadeNota',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-itapoa.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-itapoa.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-itapoa.atende.net/?pg=rest&service=WNERestServiceNFSe',
