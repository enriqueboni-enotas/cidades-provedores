var cidadeDetalhe = {
  id: 'itaquaquecetuba-sp',
  nome: 'Itaquaquecetuba',
  uf: 'SP',
  ibge: '3523107',
  constante: 'CodigoIBGE.ItaquaquecetubaSP',
  provedorAtual: {
    nome: 'SILv4',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologacao.siltecnologia.com.br/tbitaqua/services/NotaFiscalNacional',
      ...
      producao: {
        recepcaoLote: 'https://itaquaquecetuba.siltecnologia.com.br/services/NotaFiscalNacional',
