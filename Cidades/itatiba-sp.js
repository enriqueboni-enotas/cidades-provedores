var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3523404',
  constante: 'CodigoIBGE.ItatibaSP',
  provedorAtual: {
    nome: 'FintelIss',
    namespace: 'http://iss.itatiba.sp.gov.br/Arquivos/nfseV202.xsd',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://iss.itatiba.sp.gov.br:4431/Homologacao/WebService.asmx'
      },
      producao: {
        recepcaoLote: 'https://iss.itatiba.sp.gov.br:4431/WebService.asmx'
      }
    }
  },
