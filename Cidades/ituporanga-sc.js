var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4208500',
  constante: 'CodigoIBGE.ItuporangaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-ituporanga.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-ituporanga.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-ituporanga.atende.net/?pg=rest&service=WNERestServiceNFSe',
