var cidadeDetalhe = {
  ...
  uf: 'MS',
  ibge: '5004700',
  constante: 'CodigoIBGE.IvinhemaMS',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaExigibilidadeIssUm; UsaImpressaoPdfPorLink',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.ivinhema.ms.gov.br:8286/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
