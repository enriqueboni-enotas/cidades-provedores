var cidadeDetalhe = {
  id: 'jacinto-machado-sc',
  nome: 'Jacinto Machado',
  uf: 'SC',
  ibge: '4208708',
  constante: 'CodigoIBGE.JacintoMachadoSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://jacintomachado.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://jacintomachado.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://jacintomachado.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
