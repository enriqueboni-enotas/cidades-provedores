var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3525003',
  constante: 'CodigoIBGE.JandiraSP',
  provedorAtual: {
    nome: 'SILv4',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologacao.siltecnologia.com.br/tbjandira/services/NotaFiscalNacional',
      ...
      producao: {
        recepcaoLote: 'https://jandira.siltecnologia.com.br/services/NotaFiscalNacional',
