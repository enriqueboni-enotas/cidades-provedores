var cidadeDetalhe = {
  ...
  uf: 'RO',
  ibge: '1100122',
  constante: 'CodigoIBGE.JiParanaRO',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaProxy; UsaCodigoServicoMunicipal',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.ji-parana.ro.gov.br/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
