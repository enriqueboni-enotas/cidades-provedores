var cidadeDetalhe = {
  ...
  uf: 'MA',
  ibge: '2105500',
  constante: 'CodigoIBGE.JoaoLisboaMA',
  provedorAtual: {
    nome: 'PortalFacil',
    namespace: 'http://ws.taxtecnologia.com.br/ws-joaolisboa-ma/nfseserv/schema/nfse_v202.xsd',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.taxtecnologia.com.br/ws-joaolisboa-ma/homologacao/webservice/servicos.asmx'
      },
      producao: {
        recepcaoLote: 'https://ws.taxtecnologia.com.br/ws-joaolisboa-ma/nfseserv/webservice/servicos.asmx'
      }
    }
  },
