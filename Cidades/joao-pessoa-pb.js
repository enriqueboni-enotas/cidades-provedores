var cidadeDetalhe = {
  ...
  uf: 'PB',
  ibge: '2507507',
  constante: 'CodigoIBGE.JoaoPessoaPB',
  provedorAtual: {
    nome: 'DSFv2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://serem-hml.joaopessoa.pb.gov.br/notafiscal-abrasfv203-ws/NotaFiscalSoap'
      },
      producao: {
        recepcaoLote: 'https://receita.joaopessoa.pb.gov.br/notafiscal-abrasfv203-ws/NotaFiscalSoap'
      }
    }
  },
