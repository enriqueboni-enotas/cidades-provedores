var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4209102',
  constante: 'CodigoIBGE.JoinvilleSC',
  provedorAtual: {
    nome: 'PublicaV1',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfem.joinville.sc.gov.br/nfse_integracao/Services',
        consultaLote: 'https://nfem.joinville.sc.gov.br/nfse_integracao/Consultas'
      }
    }
  },
