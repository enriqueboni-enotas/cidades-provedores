var cidadeDetalhe = {
  ...
  uf: 'MT',
  ibge: '5105150',
  constante: 'CodigoIBGE.JuinaMT',
  provedorAtual: {
    nome: 'Agili',
    namespace: 'http://www.agili.com.br/nfse_v_1.00.xsd',
    codigoNoProvedor: '15359201000157;UsaItemLei116AtividadeEconomica;NaoUsaCodigoCnae;NaoItemLei116',
    robo: false,
    webService: true,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://blue.juina.mt.gov.br/api/gerarnfse',
        consultaNFe: 'https://blue.juina.mt.gov.br/api/ConsultarNfseRps/',
        cancelamentoNFe: 'https://blue.juina.mt.gov.br/api/CancelarNfse/'
      }
    }
  },
