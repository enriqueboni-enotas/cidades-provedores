var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3136900',
  constante: 'CodigoIBGE.JuruaiaMG',
  provedorAtual: {
    nome: 'eReceita',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ereceita/rpp/ws/juruaiamg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/juruaiamg/wsProducao.php'
      }
    }
  },
