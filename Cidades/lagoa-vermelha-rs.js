var cidadeDetalhe = {
  id: 'lagoa-vermelha-rs',
  nome: 'Lagoa Vermelha',
  uf: 'RS',
  ibge: '4311304',
  constante: 'CodigoIBGE.LagoaVermelhaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://lagoavermelha.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://lagoavermelha.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://lagoavermelha.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
