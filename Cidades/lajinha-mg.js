var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3137700',
  constante: 'CodigoIBGE.LajinhaMG',
  provedorAtual: {
    nome: 'EeLv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://mg-lajinha-pm-nfs-backend.cloud.el.com.br/producao36/NfseWSService',
        consultaRps: 'http://mg-lajinha-pm-nfs.cloud.el.com.br/'
      }
    }
  },
