var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-lapa.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-lapa.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-lapa.atende.net/?pg=rest&service=WNERestServiceNFSe',
