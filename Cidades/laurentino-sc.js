var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4209508',
  constante: 'CodigoIBGE.LaurentinoSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-laurentino.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-laurentino.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-laurentino.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
