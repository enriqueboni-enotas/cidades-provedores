var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3138500',
  constante: 'CodigoIBGE.LiberdadeMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://liberdademg.futurize-nfse.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://liberdademg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
