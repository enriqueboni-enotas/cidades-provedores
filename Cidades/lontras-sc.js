var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4209904',
  constante: 'CodigoIBGE.LontrasSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-lontras.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-lontras.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-lontras.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
