var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4311700',
  constante: 'CodigoIBGE.MachadinhoRS',
  provedorAtual: {
    nome: 'GOVBRv2',
    namespace: null,
    codigoNoProvedor: 'UsaAbrasf203;RegraPadraoAliquotaAbrasfv204;NaoPermiteCancelamento',
    robo: false,
    webService: true,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://webapp1-machadinho.cidade360.cloud/NFSe.Portal.Integracao/Services.svc'
      }
    }
  },
