var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3528502',
  constante: 'CodigoIBGE.MairiporaSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.mairipora/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.mairipora/webservice/aws_nfe.aspx'
      }
    }
  },
