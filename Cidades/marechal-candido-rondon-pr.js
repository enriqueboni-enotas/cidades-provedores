var cidadeDetalhe = {
  id: 'marechal-candido-rondon-pr',
  nome: 'Marechal Cândido Rondon',
  uf: 'PR',
  ibge: '4114609',
  constante: 'CodigoIBGE.MarechalCandidoRondonPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'EnviarAliquota4CasasDecimais',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://marechalcandidorondon.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://marechalcandidorondon.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://marechalcandidorondon.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
