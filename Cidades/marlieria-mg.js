var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3140308',
  constante: 'CodigoIBGE.MarlieriaMG',
  provedorAtual: {
    nome: 'PortalFacil',
    namespace: 'http://nfse.marlieria.mg.gov.br/nfseserv/schema/nfse_v204.xsd',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.marlieria.mg.gov.br/nfseserv/webservice/servicos'
      }
    }
  },
