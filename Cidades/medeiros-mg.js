var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3141306',
  constante: 'CodigoIBGE.MedeirosMG',
  provedorAtual: {
    nome: 'WebISSv2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoSuportaEmissaoSemCliente; NaoSuportaEmissaoClienteSemCpf',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://medeirosmg.gestaoiss.com.br/ws/nfse.asmx'
      }
    }
  },
