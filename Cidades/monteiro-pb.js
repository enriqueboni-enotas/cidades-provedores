var cidadeDetalhe = {
  ...
  uf: 'PB',
  ibge: '2509701',
  constante: 'CodigoIBGE.MonteiroPB',
  provedorAtual: {
    nome: 'PublicSoftV2',
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'http://api.publicsoft.com.br:443/api/gerar-token',
        recepcaoLote: 'http://api.publicsoft.com.br:443/api/gerar-nfse-envio',
        consultaRps: 'http://api.publicsoft.com.br:443/api/consultar-nfse-rps-envio',
        cancelamentoNFe: 'http://api.publicsoft.com.br:443/ws/NotaFiscalApi'
      }
    }
  },
