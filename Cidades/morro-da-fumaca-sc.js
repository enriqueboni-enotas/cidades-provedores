var cidadeDetalhe = {
  id: 'morro-da-fumaca-sc',
  nome: 'Morro da Fumaça',
  uf: 'SC',
  ibge: '4211207',
  constante: 'CodigoIBGE.MorroDaFumacaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-morrodafumaca.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-morrodafumaca.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-morrodafumaca.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
