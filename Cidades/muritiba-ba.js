var cidadeDetalhe = {
  ...
  uf: 'BA',
  ibge: '2922300',
  constante: 'CodigoIBGE.MuritibaBA',
  provedorAtual: {
    nome: 'Freire',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'REGRAPADRAOALIQUOTAABRASF;UsaMotivoCancelamento;UsaProxy',
    robo: false,
    webService: true,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://nfse.muritiba.ba.gov.br/webrun/webservices/NFEServices.jws'
      }
    }
  },
