var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://wsnfsev1.natal.rn.gov.br:8444/axis2/services/NfseWSServiceV1'
      }
    }
  },
  configuracaoProvedor: {
    ...
    naturezasOperacao: [
      ...
      { codigo: '7', nome: 'Sociedade uniprofissional' },
      { codigo: '8', nome: 'ISS Estimado' },
      { codigo: '9', nome: 'Não Incidência' }
    ]
  }
};
