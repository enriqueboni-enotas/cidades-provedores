var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4211405',
  constante: 'CodigoIBGE.NovaErechimSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-novaerechim.atende.net:7443/?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ws-novaerechim.atende.net:7443/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://ws-novaerechim.atende.net:7443/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
