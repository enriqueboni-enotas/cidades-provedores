var cidadeDetalhe = {
  ...
  uf: 'CE',
  ibge: '2309300',
  constante: 'CodigoIBGE.NovaRussasCE',
  provedorAtual: {
    nome: 'SpeedGov',
    namespace: null,
    codigoNoProvedor: 'NaoSuportaEmissaoSemCliente',
    robo: false,
    webService: true,
    versaoAbrasf: '1.01',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://speedgov.com.br/wsnov/Nfes'
      }
    },
    emissaoSemCertificado: {
      producao: 'https://iss.speedgov.com.br/novarussas'
    }
  },
