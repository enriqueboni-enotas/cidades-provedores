var cidadeDetalhe = {
  id: 'nova-santa-rita-rs',
  nome: 'Nova Santa Rita',
  uf: 'RS',
  ibge: '4313375',
  constante: 'CodigoIBGE.NovaSantaRitaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://novasantarita.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://novasantarita.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://novasantarita.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
