var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://osorio.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://osorio.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://osorio.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
