var cidadeDetalhe = {
  id: 'ouro-verde-do-oeste-pr',
  nome: 'Ouro Verde do Oeste',
  uf: 'PR',
  ibge: '4117453',
  constante: 'CodigoIBGE.OuroVerdeDoOestePR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ouroverdedooeste.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ouroverdedooeste.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://ouroverdedooeste.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
