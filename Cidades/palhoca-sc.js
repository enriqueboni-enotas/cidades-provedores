var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4211900',
  constante: 'CodigoIBGE.PalhocaSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-palhoca.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-palhoca.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-palhoca.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
