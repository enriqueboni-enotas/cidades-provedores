var cidadeDetalhe = {
  id: 'palmeira-das-missoes-rs',
  nome: 'Palmeira das Missões',
  uf: 'RS',
  ibge: '4313706',
  constante: 'CodigoIBGE.PalmeiraDasMissoesRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://palmeiradasmissoes.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://palmeiradasmissoes.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://palmeiradasmissoes.atende.net/?pg=rest&service=WNERestServiceNFSe',
