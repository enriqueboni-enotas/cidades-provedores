var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4313904',
  constante: 'CodigoIBGE.PanambiRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-panambi.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-panambi.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-panambi.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
