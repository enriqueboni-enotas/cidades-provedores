var cidadeDetalhe = {
  ...
  uf: 'RJ',
  ibge: '3303609',
  constante: 'CodigoIBGE.ParacambiRJ',
  provedorAtual: {
    nome: 'FintelIss',
    namespace: 'http://iss.paracambi.rj.gov.br/Arquivos/nfseV202.xsd',
    codigoNoProvedor: 'NaoEnviaValorIssRetido',
    robo: false,
    webService: true,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://iss.paracambi.rj.gov.br:4431/Homologacao/WebService.asmx'
      },
      producao: {
        recepcaoLote: 'https://iss.paracambi.rj.gov.br:4431/WebService.asmx'
      }
    }
  },
