var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4212239',
  constante: 'CodigoIBGE.ParaisoSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'http://sync-sc.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_login.php',
        recepcaoLote: 'http://sync-sc.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_upload.php?eletron=1',
        cancelamentoNFe: 'http://sync-sc.nfs-e.net/datacenter/include/nfw/importa_nfw/nfw_import_upload.php?eletron=1',
