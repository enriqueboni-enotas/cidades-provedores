var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4118204',
  constante: 'CodigoIBGE.ParanaguaPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-paranagua.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-paranagua.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-paranagua.atende.net/?pg=rest&service=WNERestServiceNFSe',
