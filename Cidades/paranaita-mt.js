var cidadeDetalhe = {
  ...
  uf: 'MT',
  ibge: '5106299',
  constante: 'CodigoIBGE.ParanaitaMT',
  provedorAtual: {
    nome: 'Agili',
    namespace: 'http://www.agili.com.br/nfse_v_1.00.xsd',
    codigoNoProvedor: '03239043000112;UsaItemLei116AtividadeEconomica;NaoUsaCodigoCnae;NaoItemLei116',
    robo: false,
    webService: true,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://agili.paranaita.mt.gov.br/api/GerarNfse/',
        consultaNFe: 'https://agili.paranaita.mt.gov.br/api/ConsultarNfseRps/',
        cancelamentoNFe: 'https://agili.paranaita.mt.gov.br/api/CancelarNfse/'
      }
    }
  },
