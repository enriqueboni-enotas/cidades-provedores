var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4118402',
  constante: 'CodigoIBGE.ParanavaiPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'RequerAssinatura;SomenteUmitemPorNota',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-paranavai.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-paranavai.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-paranavai.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
