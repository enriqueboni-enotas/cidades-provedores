var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3537107',
  constante: 'CodigoIBGE.PedreiraSP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoEnviaValorIss, NaoSuportaCancelamento',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://intranet.pedreira.sp.gov.br:5661/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
