var cidadeDetalhe = {
  id: 'pereira-barreto-sp',
  nome: 'Pereira Barreto',
  uf: 'SP',
  ibge: '3537404',
  constante: 'CodigoIBGE.PereiraBarretoSP',
  provedorAtual: {
    nome: 'RLZv3',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://pereirabarreto.prefeitura.rlz.com.br/nota/nacional/nfse'
      },
      producao: {
        recepcaoLote: 'https://servicos.pereirabarreto.sp.gov.br/nota/nacional/nfse',
