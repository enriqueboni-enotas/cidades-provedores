var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4119152',
  constante: 'CodigoIBGE.PinhaisPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-pinhais.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-pinhais.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-pinhais.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe',
