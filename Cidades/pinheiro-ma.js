var cidadeDetalhe = {
  ...
  uf: 'MA',
  ibge: '2108603',
  constante: 'CodigoIBGE.PinheiroMA',
  provedorAtual: {
    nome: 'AutoBahnTech',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.tributosmunicipaisma.com.br/homologacao/pinheiro/soap-server.php'
      },
      producao: {
        recepcaoLote: 'https://ws.tributosmunicipaisma.com.br/pinheiro3E5f3bg9XRAq08jNw/soap-server.php?wsdl'
      }
    }
  },
