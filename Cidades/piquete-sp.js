var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3538501',
  constante: 'CodigoIBGE.PiqueteSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomologacao.etransparencia.com.br/sp.piquete/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.piquete/webservice/aws_nfe.aspx'
      }
    }
  },
