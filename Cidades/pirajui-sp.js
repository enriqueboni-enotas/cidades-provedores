var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3538907',
  constante: 'CodigoIBGE.PirajuiSP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaImpressaoPdfPorLink; NaoUsaAssinatura',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://prefeiturapirajui1.ddns.net:3392/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
