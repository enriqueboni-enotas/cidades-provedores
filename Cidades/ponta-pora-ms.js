var cidadeDetalhe = {
  ...
  uf: 'MS',
  ibge: '5006606',
  constante: 'CodigoIBGE.PontaPoraMS',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsarItemListaServico; UsaCodigoServicoMunicipal',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://sia.pontapora.ms.gov.br/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
