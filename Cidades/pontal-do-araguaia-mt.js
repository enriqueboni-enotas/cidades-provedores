var cidadeDetalhe = {
  id: 'pontal-do-araguaia-mt',
  nome: 'Pontal do Araguaia',
  uf: 'MT',
  ibge: '5106653',
  constante: 'CodigoIBGE.PontalDoAraguaiaMT',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoUsaAssinatura; UsaCodigoServicoMunicipal; NaoUsarItemListaServico',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://190.89.178.37:8081/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
