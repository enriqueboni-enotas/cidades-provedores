var cidadeDetalhe = {
  ...
  uf: 'GO',
  ibge: '5217708',
  constante: 'CodigoIBGE.PontalinaGO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    namespace: 'http://megasoftarrecadanet.com.br/xsd/nfse_v01.xsd',
    codigoNoProvedor: 'NaoSuportaEmissaoNfeClienteSemCpf; NaoSuportaEmissaoNfeClienteSemEndereco',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://pontalina.megasoftarrecadanet.com.br/pontalina/ws/nfseSOAP'
      }
    }
  },
