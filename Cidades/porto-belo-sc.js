var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4213500',
  constante: 'CodigoIBGE.PortoBeloSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-portobelo.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-portobelo.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-portobelo.atende.net/?pg=rest&service=WNERestServiceNFSe'
      }
    }
  },
