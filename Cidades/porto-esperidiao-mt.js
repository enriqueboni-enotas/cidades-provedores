var cidadeDetalhe = {
  id: 'porto-esperidiao-mt',
  nome: 'Porto Esperidião',
  uf: 'MT',
  ibge: '5106828',
  constante: 'CodigoIBGE.PortoEsperidiaoMT',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoUsaAssinatura; UsaCodigoServicoMunicipal',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://177.222.235.98:5661/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
