var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3152303',
  constante: 'CodigoIBGE.PortoFirmeMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://portofirmemg.nfse-futurize.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://portofirmemg.nfse-futurize.com.br/webservice/prod'
      }
    }
  },
