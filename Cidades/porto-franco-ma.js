var cidadeDetalhe = {
  ...
  uf: 'MA',
  ibge: '2109007',
  constante: 'CodigoIBGE.PortoFrancoMA',
  provedorAtual: {
    nome: 'PortalFacil',
    namespace: 'http://ws.taxtecnologia.com.br/portofranco-ma/nfseserv/schema/nfse_v202.xsd',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://ws.taxtecnologia.com.br/portofranco-ma/homologacao/webservice/servicos.asmx'
      },
      producao: {
        recepcaoLote: 'http://ws.taxtecnologia.com.br/portofranco-ma/nfseserv/webservice/servicos.asmx'
      }
    }
  },
