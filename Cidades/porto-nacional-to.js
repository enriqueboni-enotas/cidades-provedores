var cidadeDetalhe = {
  id: 'porto-nacional-to',
  nome: 'Porto Nacional',
  uf: 'TO',
  ibge: '1718204',
  constante: 'CodigoIBGE.PortoNacionalTO',
  provedorAtual: {
    nome: 'WebISSv2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'EnviarAliquotaApenasSimplesNacional',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://portonacionalto.webiss.com.br/ws/nfse.asmx'
      }
    }
  },
