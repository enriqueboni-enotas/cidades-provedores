var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4213807',
  constante: 'CodigoIBGE.PraiaGrandeSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-praiagrande.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-praiagrande.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-praiagrande.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
