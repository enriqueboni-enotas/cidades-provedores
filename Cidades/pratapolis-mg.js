var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3152907',
  constante: 'CodigoIBGE.PratapolisMG',
  provedorAtual: {
    nome: 'eReceita',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ereceita/rpp/ws/pratapolismg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/pratapolismg/wsProducao.php'
      }
    }
  },
