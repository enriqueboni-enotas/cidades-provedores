var cidadeDetalhe = {
  id: 'presidente-bernardes-sp',
  nome: 'Presidente Bernardes',
  uf: 'SP',
  ibge: '3541208',
  constante: 'CodigoIBGE.PresidenteBernardesSP',
  provedorAtual: {
    nome: 'GOVBRv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://webapp1-presidentebernardes.cidade360.cloud/NFSe.Api/NotaNacional',
