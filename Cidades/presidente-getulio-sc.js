var cidadeDetalhe = {
  id: 'presidente-getulio-sc',
  nome: 'Presidente Getúlio',
  uf: 'SC',
  ibge: '4214003',
  constante: 'CodigoIBGE.PresidenteGetulioSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-presidentegetulio.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-presidentegetulio.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        cancelamentoNFe: 'https://nfse-presidentegetulio.atende.net/?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
