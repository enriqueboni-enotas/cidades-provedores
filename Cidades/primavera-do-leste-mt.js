var cidadeDetalhe = {
  ...
  uf: 'MT',
  ibge: '5107040',
  constante: 'CodigoIBGE.PrimaveraDoLesteMT',
  provedorAtual: {
    nome: 'RLZv3',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://primaveradoleste.prefeitura.rlz.com.br/nota/nacional/nfse'
      },
      producao: {
        recepcaoLote: 'https://cidadaoonline.primaveradoleste.mt.gov.br/nota/nacional/nfse',
