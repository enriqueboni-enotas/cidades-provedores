var cidadeDetalhe = {
  id: 'prudente-de-morais-mg',
  nome: 'Prudente de Morais',
  uf: 'MG',
  ibge: '3153608',
  constante: 'CodigoIBGE.PrudenteDeMoraisMG',
  provedorAtual: {
    nome: 'Memory',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://web1.memory.com.br:81/nfse/ws/lote_rps_service.php'
      },
      producao: {
        recepcaoLote: 'https://www.nfsebrasil.net.br/nfse/ws/lote_rps_service.php'
      }
    }
  },
