var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3543402',
  constante: 'CodigoIBGE.RibeiraoPretoSP',
  provedorAtual: {
    nome: 'NotaControl',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'REGRAPADRAOALIQUOTAABRASFV204; UsaCpfTomadorExterior',
    robo: false,
    webService: true,
    versaoAbrasf: '2.04',
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.issnetonline.com.br/abrasf204/ribeiraopreto/nfse.asmx'
      }
    }
  },
