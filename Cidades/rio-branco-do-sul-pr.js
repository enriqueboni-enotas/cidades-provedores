var cidadeDetalhe = {
  id: 'rio-branco-do-sul-pr',
  nome: 'Rio Branco do Sul',
  uf: 'PR',
  ibge: '4122206',
  constante: 'CodigoIBGE.RioBrancoDoSulPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'ConsultaRpsPorNumeroNota,NaoUsaRPS,UsaDataFatoGerador',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-riobrancodosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-riobrancodosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-riobrancodosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
