var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4214805',
  constante: 'CodigoIBGE.RioDoSulSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'RequerAssinatura',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://riodosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://riodosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://riodosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
