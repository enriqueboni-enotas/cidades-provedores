var cidadeDetalhe = {
  id: 'rio-dos-cedros-sc',
  nome: 'Rio dos Cedros',
  uf: 'SC',
  ibge: '4214706',
  constante: 'CodigoIBGE.RioDosCedrosSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-riodoscedros.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-riodoscedros.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-riodoscedros.atende.net/?pg=rest&service=WNERestServiceNFSe',
