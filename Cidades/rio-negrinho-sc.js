var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4215000',
  constante: 'CodigoIBGE.RioNegrinhoSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-rionegrinho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-rionegrinho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-rionegrinho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      }
    }
  },
