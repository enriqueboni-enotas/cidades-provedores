var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4122305',
  constante: 'CodigoIBGE.RioNegroPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-rionegro.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-rionegro.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-rionegro.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
