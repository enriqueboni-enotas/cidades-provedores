var cidadeDetalhe = {
  id: 'rio-pardo-de-minas-mg',
  nome: 'Rio Pardo de Minas',
  uf: 'MG',
  ibge: '3155603',
  constante: 'CodigoIBGE.RioPardoDeMinasMG',
  provedorAtual: {
    nome: 'Sintese',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaCnae;UsaItemListaServico;UsaSinteseNotaFiscal;NaoSuportaEmissaoSemTomador',
    robo: false,
    webService: true,
    versaoAbrasf: '2.01',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://riopardodeminas.sintesenotafiscal.com.br/nfsews/NfseWS'
      }
    }
  },
