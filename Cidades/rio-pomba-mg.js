var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3155801',
  constante: 'CodigoIBGE.RioPombaMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://riopombamg.nfse-futurize.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://riopombamg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
