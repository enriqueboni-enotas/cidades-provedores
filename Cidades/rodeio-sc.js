var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4215109',
  constante: 'CodigoIBGE.RodeioSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaISO88591Envio;FormatarDadosNFSeCancelamento',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://rodeio.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://rodeio.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://rodeio.atende.net/?pg=rest&service=WNERestServiceNFSe',
