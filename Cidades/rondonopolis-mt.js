var cidadeDetalhe = {
  ...
  uf: 'MT',
  ibge: '5107602',
  constante: 'CodigoIBGE.RondonopolisMT',
  provedorAtual: {
    nome: 'Agili',
    namespace: 'http://www.agili.com.br/nfse_v_1.00.xsd',
    codigoNoProvedor: '03347101000121;UsaItemLei116AtividadeEconomica;NaoItemLei116;NaoUsaCodigoCnae',
    robo: false,
    webService: true,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse.rondonopolis.mt.gov.br/api/GerarNfse',
        consultaNFe: 'https://nfse.rondonopolis.mt.gov.br/api/ConsultarNfseRps/',
        cancelamentoNFe: 'https://nfse.rondonopolis.mt.gov.br/api/CancelarNfse/'
      },
      producao: {
        recepcaoLote: 'https://nfse.rondonopolis.mt.gov.br/api/GerarNfse',
        consultaNFe: 'https://nfse.rondonopolis.mt.gov.br/api/ConsultarNfseRps/',
