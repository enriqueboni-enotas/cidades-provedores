var cidadeDetalhe = {
  ...
  uf: 'RR',
  ibge: '1400472',
  constante: 'CodigoIBGE.RorainopolisRR',
  provedorAtual: {
    nome: 'Saatri',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologa-rorainopolis.saatri.com.br/servicos/nfse.svc'
      },
      producao: {
        recepcaoLote: 'https://rorainopolis.saatri.com.br/servicos/nfse.svc'
      }
    }
  },
