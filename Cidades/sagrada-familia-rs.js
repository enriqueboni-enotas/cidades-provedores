var cidadeDetalhe = {
  id: 'sagrada-familia-rs',
  nome: 'Sagrada Família',
  uf: 'RS',
  ibge: '4316428',
  constante: 'CodigoIBGE.SagradaFamiliaRS',
  provedorAtual: {
    nome: 'SIMv2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sim.digifred.net.br/sagradafamilia_homolog/nfse/ws/principal'
      },
      producao: {
        recepcaoLote: 'https://sim.digifred.net.br/sagradafamilia/nfse/ws/principal'
      }
    }
  },
