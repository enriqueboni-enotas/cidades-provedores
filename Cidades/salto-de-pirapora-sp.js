var cidadeDetalhe = {
  id: 'salto-de-pirapora-sp',
  nome: 'Salto de Pirapora',
  uf: 'SP',
  ibge: '3545308',
  constante: 'CodigoIBGE.SaltoDePiraporaSP',
  provedorAtual: {
    nome: 'ISSOnline',
    namespace: null,
    codigoNoProvedor: 'NaoUsaCertificado',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://s64.asp.srv.br/issonline/servlet/anfse'
      }
    }
  },
