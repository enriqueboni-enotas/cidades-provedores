var cidadeDetalhe = {
  id: 'santa-barbara-d-oeste-sp',
  nome: 'Santa Bárbara d\'Oeste',
  uf: 'SP',
  ibge: '3545803',
  constante: 'CodigoIBGE.SantaBarbaraDOesteSP',
  provedorAtual: {
    nome: 'SIGISSWeb',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://wshml.sigissweb.com/rest/'
      },
      producao: {
        recepcaoLote: 'https://wssantabarbara.sigissweb.com/rest/'
      }
    }
  },
