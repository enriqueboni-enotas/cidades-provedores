var cidadeDetalhe = {
  id: 'santa-barbara-do-leste-mg',
  nome: 'Santa Bárbara do Leste',
  uf: 'MG',
  ibge: '3157252',
  constante: 'CodigoIBGE.SantaBarbaraDoLesteMG',
  provedorAtual: {
    nome: 'EeLv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://mg-santabarbaradoleste-pm-nfs-backend.cloud.el.com.br/producao06/NfseWSService'
      }
    }
  },
