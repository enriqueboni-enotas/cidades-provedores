var cidadeDetalhe = {
  id: 'santa-cruz-da-conceicao-sp',
  nome: 'Santa Cruz da Conceição',
  uf: 'SP',
  ibge: '3546207',
  constante: 'CodigoIBGE.SantaCruzDaConceicaoSP',
  provedorAtual: {
    nome: 'Fiorilli',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://stacruzdaconceicao.ddns.net:5656/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
