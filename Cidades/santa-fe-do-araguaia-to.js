var cidadeDetalhe = {
  id: 'santa-fe-do-araguaia-to',
  nome: 'Santa Fé do Araguaia',
  uf: 'TO',
  ibge: '1718865',
  constante: 'CodigoIBGE.SantaFeDoAraguaiaTO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://santafedoaraguaia.megasoftarrecadanet.com.br/santafedoaraguaia/ws/nfseSOAP'
      }
    }
  },
