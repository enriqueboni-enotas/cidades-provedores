var cidadeDetalhe = {
  id: 'santa-izabel-do-para-pa',
  nome: 'Santa Izabel do Pará',
  uf: 'PA',
  ibge: '1506500',
  constante: 'CodigoIBGE.SantaIzabelDoParaPA',
  provedorAtual: {
    nome: 'PortalFacil',
    namespace: 'http://ws.taxtecnologia.com.br/santaizabel-pa/nfseserv/schema/nfse_v202.xsd',
    codigoNoProvedor: null,
    robo: false,
    webService: true,
    naoEnviaSerieRPS: false,
    versaoAbrasf: '2.01;2.02;2.04',
    infoAdicional: 'Preferir ativar versao 2.04 pois a versao 2.01 tem q adicionar o ws de cada cidade',
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.taxtecnologia.com.br/santaizabel-pa/homologacao/webservice/servicos.asmx'
      },
      producao: {
        recepcaoLote: 'https://ws.taxtecnologia.com.br/santaizabel-pa/nfseserv/webservice/servicos.asmx'
      }
    }
  },
