var cidadeDetalhe = {
  id: 'santa-maria-da-boa-vista-pe',
  nome: 'Santa Maria da Boa Vista',
  uf: 'PE',
  ibge: '2612604',
  constante: 'CodigoIBGE.SantaMariaDaBoaVistaPE',
  provedorAtual: {
    nome: 'SpeedGov',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://speedgov.com.br/wssma/Nfes'
      }
    },
    emissaoSemCertificado: {
      producao: 'https://iss.speedgov.com.br/santamariadaboavista'
    }
  },
