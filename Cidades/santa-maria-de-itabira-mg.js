var cidadeDetalhe = {
  id: 'santa-maria-de-itabira-mg',
  nome: 'Santa Maria de Itabira',
  uf: 'MG',
  ibge: '3158003',
  constante: 'CodigoIBGE.SantaMariaDeItabiraMG',
  provedorAtual: {
    nome: 'IssLegal',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://200.251.30.48:8080/serversoap/NfseWSService'
      },
      producao: {
        recepcaoLote: 'https://api.redemunicipal.com.br/serversoap/NfseWSService'
      }
    }
  },
