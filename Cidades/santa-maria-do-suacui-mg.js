var cidadeDetalhe = {
  id: 'santa-maria-do-suacui-mg',
  nome: 'Santa Maria do Suaçuí',
  uf: 'MG',
  ibge: '3158201',
  constante: 'CodigoIBGE.SantaMariaDoSuacuiMG',
  provedorAtual: {
    nome: 'DBSeller',
    namespace: 'http://www.abrasf.org.br/ABRASF/arquivos/nfse.xsd',
    codigoNoProvedor: 'UsaPadrao; NaoConsultaSituacaoLote; UsaCodigoServicoSemPonto',
    robo: false,
    webService: true,
    versaoAbrasf: '1.0',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'http://189.126.111.18:8084/webservice/index/homologacao'
      },
      producao: {
        recepcaoLote: 'http://189.126.111.18:8084/webservice/index/producao'
      }
    }
  },
