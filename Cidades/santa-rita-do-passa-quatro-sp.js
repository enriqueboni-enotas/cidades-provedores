var cidadeDetalhe = {
  id: 'santa-rita-do-passa-quatro-sp',
  nome: 'Santa Rita do Passa Quatro',
  uf: 'SP',
  ibge: '3547502',
  constante: 'CodigoIBGE.SantaRitaDoPassaQuatroSP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: '3883',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://prefsrpq.com.br:5661/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
