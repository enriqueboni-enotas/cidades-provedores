var cidadeDetalhe = {
  ...
  uf: 'PB',
  ibge: '2513703',
  constante: 'CodigoIBGE.SantaRitaPB',
  provedorAtual: {
    nome: 'Agili',
    namespace: 'http://www.agili.com.br/nfse_v_1.00.xsd',
    codigoNoProvedor: '09159666000161;UsaItemLei116AtividadeEconomica;NaoItemLei116;',
    robo: false,
    webService: true,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse.santarita.pb.gov.br/api/GerarNfse',
        consultaNFe: 'https://nfse.santarita.pb.gov.br/api/ConsultarNfseRps/',
        cancelamentoNFe: 'https://nfse.santarita.pb.gov.br/api/CancelarNfse/'
      },
      producao: {
        recepcaoLote: 'https://nfse.santarita.pb.gov.br/api/GerarNfse',
        consultaNFe: 'https://nfse.santarita.pb.gov.br/api/ConsultarNfseRps/',
