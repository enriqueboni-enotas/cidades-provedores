var cidadeDetalhe = {
  id: 'santa-rosa-do-sul-sc',
  nome: 'Santa Rosa do Sul',
  uf: 'SC',
  ibge: '4215653',
  constante: 'CodigoIBGE.SantaRosaDoSulSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://santarosadosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://santarosadosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://santarosadosul.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
