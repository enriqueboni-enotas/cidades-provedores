var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4317202',
  constante: 'CodigoIBGE.SantaRosaRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-santarosa.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-santarosa.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-santarosa.atende.net/?pg=rest&service=WNERestServiceNFSe',
        cancelamentoNFe: 'https://ws-santarosa.atende.net/?pg=rest&service=WNERestServiceNFSe',
