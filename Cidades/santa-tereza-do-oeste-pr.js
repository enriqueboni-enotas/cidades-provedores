var cidadeDetalhe = {
  ...
  uf: 'PR',
  ibge: '4124020',
  constante: 'CodigoIBGE.SantaTerezaDoOestePR',
  provedorAtual: {
    nome: 'Elotech',
    namespace: 'http://shad.elotech.com.br/schemas/iss/nfse_v2_03.xsd',
    codigoNoProvedor: 'EnviaValorIssNull; FormataCodigoPaisTomador',
    robo: false,
    webService: true,
    versaoAbrasf: '2.03',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://santaterezadooeste.oxy.elotech.com.br/iss-ws/nfse203.wsdl'
      }
    }
  },
