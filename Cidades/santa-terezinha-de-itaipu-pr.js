var cidadeDetalhe = {
  id: 'santa-terezinha-de-itaipu-pr',
  nome: 'Santa Terezinha de Itaipu',
  uf: 'PR',
  ibge: '4124053',
  constante: 'CodigoIBGE.SantaTerezinhaDeItaipuPR',
  provedorAtual: {
    nome: 'GOVBRv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://webapp1-santaterezinhaitaipu.cidade360.cloud/NFSe.Api/NotaNacional',
