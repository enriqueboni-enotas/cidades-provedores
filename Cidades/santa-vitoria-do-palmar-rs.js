var cidadeDetalhe = {
  id: 'santa-vitoria-do-palmar-rs',
  nome: 'Santa Vitória do Palmar',
  uf: 'RS',
  ibge: '4317301',
  constante: 'CodigoIBGE.SantaVitoriaDoPalmarRS',
  provedorAtual: {
    nome: 'GOVBRv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://webapp1-santavitoriadopalmar.cidade360.cloud/NFSe.Api/NotaNacional',
