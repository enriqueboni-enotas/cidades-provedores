var cidadeDetalhe = {
  ...
  uf: 'AP',
  ibge: '1600600',
  constante: 'CodigoIBGE.SantanaAP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoUsaAssinatura; UsaProxy',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://tributossantana.transparenciabr.net:5662/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
