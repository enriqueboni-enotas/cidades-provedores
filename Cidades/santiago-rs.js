var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4317400',
  constante: 'CodigoIBGE.SantiagoRS',
  provedorAtual: {
    nome: 'GIF',
    namespace: null,
    codigoNoProvedor: 'AceitaTomadorSemEndereco',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://santiago-homol.infisc.com.br/portal/Servicos'
      },
      producao: {
        recepcaoLote: 'https://nfse.santiago.rs.gov.br/portal/Servicos'
      }
    }
  },
