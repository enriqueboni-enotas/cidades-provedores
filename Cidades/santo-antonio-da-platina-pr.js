var cidadeDetalhe = {
  id: 'santo-antonio-da-platina-pr',
  nome: 'Santo Antônio da Platina',
  uf: 'PR',
  ibge: '4124103',
  constante: 'CodigoIBGE.SantoAntonioDaPlatinaPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://santoantoniodaplatina.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://santoantoniodaplatina.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://santoantoniodaplatina.atende.net/?pg=rest&service=WNERestServiceNFSe',
