var cidadeDetalhe = {
  id: 'santo-antonio-de-goias-go',
  nome: 'Santo Antônio de Goiás',
  uf: 'GO',
  ibge: '5219738',
  constante: 'CodigoIBGE.SantoAntonioDeGoiasGO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    namespace: 'http://megasoftarrecadanet.com.br/xsd/nfse_v01.xsd',
    codigoNoProvedor: 'NaoUtilizaResponsavelRetencao;NaoSuportaEmissaoSemCliente;NaoSuportaEmissaoNfeClienteSemCpf;NaoSuportaEmissaoNfeClienteSemEndereco',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://santoantoniodegoias.megasoftarrecadanet.com.br/santoantoniodegoias/ws/nfseSOAP'
      }
    }
  },
