var cidadeDetalhe = {
  id: 'santo-antonio-do-monte-mg',
  nome: 'Santo Antônio do Monte',
  uf: 'MG',
  ibge: '3160405',
  constante: 'CodigoIBGE.SantoAntonioDoMonteMG',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-santoantoniodomonte.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ws-santoantoniodomonte.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://ws-santoantoniodomonte.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
