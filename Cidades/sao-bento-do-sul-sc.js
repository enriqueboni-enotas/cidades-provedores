var cidadeDetalhe = {
  id: 'sao-bento-do-sul-sc',
  nome: 'São Bento do Sul',
  uf: 'SC',
  ibge: '4215802',
  constante: 'CodigoIBGE.SaoBentoDoSulSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://saobentodosul.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://saobentodosul.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://saobentodosul.atende.net/?pg=rest&service=WNERestServiceNFSe',
