var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4318002',
  constante: 'CodigoIBGE.SaoBorjaRS',
  provedorAtual: {
    nome: 'GIFv2',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sefin.saoborja-homol.infisc.com.br/sefinnacional',
        downloadPDF: 'https://adn.producaorestrita.nfse.gov.br/danfse'
      },
      producao: {
        recepcaoLote: 'https://sefin.saoborja.rs.gov.br/sefinnacional',
