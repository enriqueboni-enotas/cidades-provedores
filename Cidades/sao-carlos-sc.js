var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4216008',
  constante: 'CodigoIBGE.SaoCarlosSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-saocarlos.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ws-saocarlos.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://ws-saocarlos.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
