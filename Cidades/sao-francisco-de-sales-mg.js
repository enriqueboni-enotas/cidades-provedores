var cidadeDetalhe = {
  id: 'sao-francisco-de-sales-mg',
  nome: 'São Francisco de Sales',
  uf: 'MG',
  ibge: '3161304',
  constante: 'CodigoIBGE.SaoFranciscoDeSalesMG',
  provedorAtual: {
    nome: 'GovDigital',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.homolog.nfe-cidades.com.br/ws/sfs'
      },
      producao: {
        recepcaoLote: 'https://ws.nfe-cidades.com.br/ws/sfs'
      }
    }
  },
