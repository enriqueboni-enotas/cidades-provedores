var cidadeDetalhe = {
  id: 'sao-francisco-do-sul-sc',
  nome: 'São Francisco do Sul',
  uf: 'SC',
  ibge: '4216206',
  constante: 'CodigoIBGE.SaoFranciscoDoSulSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-saofranciscodosul.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-saofranciscodosul.atende.net/?pg=rest&service=WNERestServiceNFSe',
        consultaRps: 'https://ws-saofranciscodosul.atende.net/?pg=rest&service=WNERestServiceNFSe',
