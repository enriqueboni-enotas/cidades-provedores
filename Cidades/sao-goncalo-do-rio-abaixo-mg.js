var cidadeDetalhe = {
  id: 'sao-goncalo-do-rio-abaixo-mg',
  nome: 'São Gonçalo do Rio Abaixo',
  uf: 'MG',
  ibge: '3161908',
  constante: 'CodigoIBGE.SaoGoncaloDoRioAbaixoMG',
  provedorAtual: {
    nome: 'GOVBRv3',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://webapp1-saogoncalo.cidade360.cloud/NFSe.Api/NotaNacional',
