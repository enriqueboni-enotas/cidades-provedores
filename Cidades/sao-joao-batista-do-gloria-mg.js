var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3162203',
  constante: 'CodigoIBGE.SaoJoaoBatistaDoGloriaMG',
  provedorAtual: {
    nome: 'eReceita',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ereceita/rpp/ws/saojoaobatistadogloriamg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/saojoaobatistadogloriamg/wsProducao.php'
      }
    }
  },
