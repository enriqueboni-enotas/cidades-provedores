var cidadeDetalhe = {
  id: 'sao-joao-d-alianca-go',
  nome: 'São João d\'Aliança',
  uf: 'GO',
  ibge: '5220009',
  constante: 'CodigoIBGE.SaoJoaoDAliancaGO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://saojoaodaalianca.megasoftarrecadanet.com.br/saojoaodaalianca/ws/nfseSOAP'
      }
    }
  },
