var cidadeDetalhe = {
  id: 'sao-joao-do-itaperiu-sc',
  nome: 'São João do Itaperiú',
  uf: 'SC',
  ibge: '4216354',
  constante: 'CodigoIBGE.SaoJoaoDoItaperiuSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://saojoaodoitaperiu.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://saojoaodoitaperiu.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://saojoaodoitaperiu.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
