var cidadeDetalhe = {
  id: 'sao-joao-do-polesine-rs',
  nome: 'São João do Polêsine',
  uf: 'RS',
  ibge: '4318432',
  constante: 'CodigoIBGE.SaoJoaoDoPolesineRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-saojoaodopolesine.atende.net/?pg=rest&service=WNERestServiceNFSe'
      },
      producao: {
        recepcaoLote: 'https://ws-saojoaodopolesine.atende.net/?pg=rest&service=WNERestServiceNFSe'
      }
