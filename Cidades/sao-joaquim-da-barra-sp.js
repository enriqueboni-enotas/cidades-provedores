var cidadeDetalhe = {
  id: 'sao-joaquim-da-barra-sp',
  nome: 'São Joaquim da Barra',
  uf: 'SP',
  ibge: '3549409',
  constante: 'CodigoIBGE.SaoJoaquimDaBarraSP',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsarItemListaServico, UsaProxy',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://intranet.saojoaquimdabarra.sp.gov.br:5661/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
