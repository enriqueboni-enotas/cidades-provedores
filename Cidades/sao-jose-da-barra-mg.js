var cidadeDetalhe = {
  id: 'sao-jose-da-barra-mg',
  nome: 'São José da Barra',
  uf: 'MG',
  ibge: '3162948',
  constante: 'CodigoIBGE.SaoJoseDaBarraMG',
  provedorAtual: {
    nome: 'eReceita',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://www3.ereceita.net.br/ws/saojosedabarramg/wsHomologacao.php'
      },
      producao: {
        recepcaoLote: 'https://webservice.ereceita.net.br/ws/saojosedabarramg/wsProducao.php'
      }
    }
  },
