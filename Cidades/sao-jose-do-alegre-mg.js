var cidadeDetalhe = {
  id: 'sao-jose-do-alegre-mg',
  nome: 'São José do Alegre',
  uf: 'MG',
  ibge: '3163201',
  constante: 'CodigoIBGE.SaoJoseDoAlegreMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://saojosedoalegremg.futurize-nfse.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://saojosedoalegremg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
