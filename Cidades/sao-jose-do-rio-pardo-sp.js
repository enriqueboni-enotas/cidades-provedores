var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3549706',
  constante: 'CodigoIBGE.SaoJoseDoRioPardoSP',
  provedorAtual: {
    nome: 'GovDigital',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.homolog.nfe-cidades.com.br/ws/sjrpardo'
      },
      producao: {
        recepcaoLote: 'https://ws.nfe-cidades.com.br/ws/sjrpardo'
      }
    }
  },
