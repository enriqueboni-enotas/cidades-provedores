var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4216602',
  constante: 'CodigoIBGE.SaoJoseSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    codigoNoProvedor: 'UsaAutenticidadeNota;UsaEnderecoInformado',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-saojose.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-saojose.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-saojose.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
