var cidadeDetalhe = {
  id: 'sao-lourenco-da-mata-pe',
  nome: 'São Lourenço da Mata',
  uf: 'PE',
  ibge: '2613701',
  constante: 'CodigoIBGE.SaoLourencoDaMataPE',
  provedorAtual: {
    nome: 'Tributus',
    ...
    urls: {
      ...
      producao: {
        autenticacao: 'https://www.tributosmunicipais.com.br/NFE-saolourenco/',
        recepcaoLote: 'https://www.tributosmunicipais.com.br/NFE-saolourenco/'
      }
    }
  },
