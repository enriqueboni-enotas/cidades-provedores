var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3550308',
  constante: 'CodigoIBGE.SaoPauloSP',
  provedorAtual: {
    nome: 'SaoPaulo',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfews.prefeitura.sp.gov.br/lotenfe.asmx'
      },
      producao: {
        recepcaoLote: 'https://nfews.prefeitura.sp.gov.br/lotenfe.asmx',
        consultaRps: 'https://nfe.prefeitura.sp.gov.br/contribuinte/exportaarquivoNFTS.aspx'
      }
    },
    emissaoSemCertificado: {
      producao: 'https://nfe.prefeitura.sp.gov.br/contribuinte'
    }
  },
