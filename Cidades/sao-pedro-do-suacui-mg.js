var cidadeDetalhe = {
  id: 'sao-pedro-do-suacui-mg',
  nome: 'São Pedro do Suaçuí',
  uf: 'MG',
  ibge: '3164100',
  constante: 'CodigoIBGE.SaoPedroDoSuacuiMG',
  provedorAtual: {
    nome: 'Sintese',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaSinteseNotaFiscal;UsaCnae;UsaItemListaServico;NaoSuportaEmissaoSemTomador;NaoSuportaEmissaoTomadorSemCpf',
    robo: false,
    webService: true,
    versaoAbrasf: '2.01',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://saopedrodosuacui.sintesenotafiscal.com.br/nfsews/NfseWS'
      }
    }
  },
