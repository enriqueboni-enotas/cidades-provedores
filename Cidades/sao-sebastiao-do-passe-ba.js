var cidadeDetalhe = {
  id: 'sao-sebastiao-do-passe-ba',
  nome: 'São Sebastião do Passé',
  uf: 'BA',
  ibge: '2929503',
  constante: 'CodigoIBGE.SaoSebastiaoDoPasseBA',
  provedorAtual: {
    nome: 'Saatri',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://homologa-saosebastiaodopasse.saatri.com.br/servicos/nfse.svc'
      },
      producao: {
        recepcaoLote: 'https://saosebastiaodopasse.saatri.com.br/servicos/nfse.svc'
      }
    }
  },
