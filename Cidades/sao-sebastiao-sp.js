var cidadeDetalhe = {
  ...
  uf: 'SP',
  ibge: '3550704',
  constante: 'CodigoIBGE.SaoSebastiaoSP',
  provedorAtual: {
    nome: 'IIBrasil',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://api.iibr.com.br/3550704/1/soap/homologacao/rps'
      },
      producao: {
        autenticacao: 'https://saosebastiao.iibr.com.br/',
        recepcaoLote: 'https://api.iibr.com.br/3550704/1/soap/producao/rps',
        downloadPDF: 'https://saosebastiao.iibr.com.br/'
      }
    }
  },
