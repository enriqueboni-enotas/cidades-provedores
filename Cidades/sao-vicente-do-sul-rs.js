var cidadeDetalhe = {
  id: 'sao-vicente-do-sul-rs',
  nome: 'São Vicente do Sul',
  uf: 'RS',
  ibge: '4319802',
  constante: 'CodigoIBGE.SaoVicenteDoSulRS',
  provedorAtual: {
    nome: 'SIMv2',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sim.digifred.net.br/saovicentedosul_homolog/nfse/ws/principal'
      },
      producao: {
        recepcaoLote: 'https://sim.digifred.net.br/saovicentedosul/nfse/ws/principal'
      }
    }
  },
