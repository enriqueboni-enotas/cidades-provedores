var cidadeDetalhe = {
  id: 'sapucaia-do-sul-rs',
  nome: 'Sapucaia do Sul',
  uf: 'RS',
  ibge: '4320008',
  constante: 'CodigoIBGE.SapucaiaDoSulRS',
  provedorAtual: {
    nome: 'GIFv2',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://sefin.sapucaiadosul-homol.infisc.com.br/sefinnacional',
        downloadPDF: 'https://adn.producaorestrita.nfse.gov.br/danfse'
      },
      producao: {
        recepcaoLote: 'https://sefin.sapucaiadosul.rs.gov.br/sefinnacional',
