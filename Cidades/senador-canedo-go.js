var cidadeDetalhe = {
  id: 'senador-canedo-go',
  nome: 'Senador Canedo',
  uf: 'GO',
  ibge: '5220454',
  constante: 'CodigoIBGE.SenadorCanedoGO',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'UsaCodigoServicoMunicipal; UsaProxy; UsaCidadePrestacaoParaCancelamento',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://servicosweb.senadorcanedo.go.gov.br/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
