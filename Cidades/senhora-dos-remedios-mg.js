var cidadeDetalhe = {
  id: 'senhora-dos-remedios-mg',
  nome: 'Senhora dos Remédios',
  uf: 'MG',
  ibge: '3166204',
  constante: 'CodigoIBGE.SenhoraDosRemediosMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://senhoradosremediosmg.futurize-nfse.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://senhoradosremediosmg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
