var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4320701',
  constante: 'CodigoIBGE.SobradinhoRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-sobradinho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ws-sobradinho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://ws-sobradinho.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
