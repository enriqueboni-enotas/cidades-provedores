var cidadeDetalhe = {
  id: 'soledade-de-minas-mg',
  nome: 'Soledade de Minas',
  uf: 'MG',
  ibge: '3167806',
  constante: 'CodigoIBGE.SoledadeDeMinasMG',
  provedorAtual: {
    nome: 'Futurize',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://soledadedeminasmg.futurize-nfse.com.br/webservice/homo'
      },
      producao: {
        recepcaoLote: 'https://soledadedeminasmg.futurize-nfse.com.br/webservice/prod'
      }
    }
  },
