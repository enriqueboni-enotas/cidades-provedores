var cidadeDetalhe = {
  id: 'taboao-da-serra-sp',
  nome: 'Taboão da Serra',
  uf: 'SP',
  ibge: '3552809',
  constante: 'CodigoIBGE.TaboaoDaSerraSP',
  provedorAtual: {
    nome: 'eTransparencia',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfehomo.etransparencia.com.br/sp.taboaodaserra/webservice/aws_nfe.aspx'
      },
      producao: {
        recepcaoLote: 'https://nfe.etransparencia.com.br/sp.taboaodaserra/webservice/aws_nfe.aspx'
      }
    }
  },
