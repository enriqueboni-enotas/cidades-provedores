var cidadeDetalhe = {
  id: 'tabuleiro-do-norte-ce',
  nome: 'Tabuleiro do Norte',
  uf: 'CE',
  ibge: '2313104',
  constante: 'CodigoIBGE.TabuleiroDoNorteCE',
  provedorAtual: {
    nome: 'SpeedGov',
    namespace: null,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://speedgov.com.br/wstbn/Nfes'
      }
    },
    emissaoSemCertificado: {
      producao: 'https://iss.speedgov.com.br/tabuleirodonorte'
    }
  },
