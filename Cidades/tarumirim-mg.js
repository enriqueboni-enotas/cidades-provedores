var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3168408',
  constante: 'CodigoIBGE.TarumirimMG',
  provedorAtual: {
    nome: 'VersaTecnologia',
    namespace: 'https://nfse.tarumirim.mg.gov.br/webservices/2.04/nfse_v204.xsd',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://nfse.tarumirim.mg.gov.br/webservices/2.04/servicos'
      }
    }
  },
