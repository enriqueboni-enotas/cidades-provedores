var cidadeDetalhe = {
  id: 'telemaco-borba-pr',
  nome: 'Telêmaco Borba',
  uf: 'PR',
  ibge: '4127106',
  constante: 'CodigoIBGE.TelemacoBorbaPR',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws-telemacoborba.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://ws-telemacoborba.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-telemacoborba.atende.net/?pg=rest&service=WNERestServiceNFSe',
