var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4218004',
  constante: 'CodigoIBGE.TijucasSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-tijucas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-tijucas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-tijucas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
