var cidadeDetalhe = {
  ...
  provedorAtual: {
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://timbo.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://timbo.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://timbo.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
