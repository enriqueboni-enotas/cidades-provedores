var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3169406',
  constante: 'CodigoIBGE.TresPontasMG',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://trespontas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://trespontas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://trespontas.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
