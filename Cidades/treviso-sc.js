var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4218350',
  constante: 'CodigoIBGE.TrevisoSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-treviso.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-treviso.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-treviso.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
