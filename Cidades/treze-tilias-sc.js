var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4218509',
  constante: 'CodigoIBGE.TrezeTiliasSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-trezetilias.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-trezetilias.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-trezetilias.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
