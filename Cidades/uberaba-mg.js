var cidadeDetalhe = {
  ...
  uf: 'MG',
  ibge: '3170107',
  constante: 'CodigoIBGE.UberabaMG',
  provedorAtual: {
    nome: 'WebISSv2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoSuportaEmissaoSemCliente; EnviaCodigoTributacaoEItemLista; NaoSuportaEmissaoClienteSemCpf',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://uberabamg.webiss.com.br/ws/nfse.asmx'
      }
    }
  },
