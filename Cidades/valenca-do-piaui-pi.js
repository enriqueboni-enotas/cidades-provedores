var cidadeDetalhe = {
  id: 'valenca-do-piaui-pi',
  nome: 'Valença do Piauí',
  uf: 'PI',
  ibge: '2211308',
  constante: 'CodigoIBGE.ValencaDoPiauiPI',
  provedorAtual: {
    nome: 'Fiorilli',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoUsaAssinatura, UsaProxy, UsaCNAE, UsaCodigoServicoMunicipal, UsarItemListaServico',
    robo: false,
    webService: true,
    versaoAbrasf: '2.02',
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'http://contreinaweb1.dcfiorilli.com.br:8125/IssWeb-ejb/IssWebWS/IssWebWS'
      }
    }
  },
