var cidadeDetalhe = {
  id: 'vargem-grande-paulista-sp',
  nome: 'Vargem Grande Paulista',
  uf: 'SP',
  ibge: '3556453',
  constante: 'CodigoIBGE.VargemGrandePaulistaSP',
  provedorAtual: {
    nome: 'GovDigital',
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://ws.homolog.nfe-cidades.com.br/ws/vgp'
      },
      producao: {
        recepcaoLote: 'https://ws.nfe-cidades.com.br/ws/vgp'
      }
    }
  },
