var cidadeDetalhe = {
  ...
  uf: 'CE',
  ibge: '2313955',
  constante: 'CodigoIBGE.VarjotaCE',
  provedorAtual: {
    nome: 'SatreSsIV2',
    namespace: 'http://www.abrasf.org.br/nfse.xsd',
    codigoNoProvedor: 'NaoSuportaCancelamento;NaoEnviaUFTomadorExterior;NaoPermiteSubstituicaoDeNota',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://varjota.ssinformatica.net/ws/nfse.wsdl',
