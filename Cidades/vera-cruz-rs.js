var cidadeDetalhe = {
  ...
  uf: 'RS',
  ibge: '4322707',
  constante: 'CodigoIBGE.VeraCruzRS',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://veracruz.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://veracruz.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://veracruz.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
