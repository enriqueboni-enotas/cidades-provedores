var cidadeDetalhe = {
  ...
  uf: 'GO',
  ibge: '5222005',
  constante: 'CodigoIBGE.VianopolisGO',
  provedorAtual: {
    nome: 'ArrecadaNet',
    namespace: 'http://megasoftarrecadanet.com.br/xsd/nfse_v01.xsd',
    codigoNoProvedor: 'NaoSuportaEmissaoSemCliente;NaoSuportaEmissaoNfeClienteSemEndereco;UsaDocumentoTomadorExterior',
    robo: false,
    webService: true,
    urls: {
      homologacao: {
      ...
      producao: {
        recepcaoLote: 'https://vianopolis.megasoftarrecadanet.com.br/vianopolis/ws/nfseSOAP'
      }
    }
  },
