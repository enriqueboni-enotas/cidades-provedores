var cidadeDetalhe = {
  ...
  uf: 'MS',
  ibge: '5008404',
  constante: 'CodigoIBGE.VicentinaMS',
  provedorAtual: {
    nome: 'Agili',
    namespace: 'http://www.agili.com.br/nfse_v_1.00.xsd',
    codigoNoProvedor: '24644502000113;UsaCodigoCnaeAtividadeEconomica',
    robo: false,
    webService: true,
    ...
    urls: {
      ...
      producao: {
        recepcaoLote: 'https://agilibluems.ddns.com.br/api/GerarNfse/',
        consultaNFe: 'https://agilibluems.ddns.com.br/api/ConsultarNfseRps/',
        cancelamentoNFe: 'https://agilibluems.ddns.com.br/api/CancelarNfse/'
      }
    }
  },
