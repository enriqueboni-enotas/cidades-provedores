var cidadeDetalhe = {
  ...
  uf: 'SC',
  ibge: '4219309',
  constante: 'CodigoIBGE.VideiraSC',
  provedorAtual: {
    nome: 'IPM',
    namespace: null,
    ...
    urls: {
      homologacao: {
        recepcaoLote: 'https://nfse-videira.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao'
      },
      producao: {
        recepcaoLote: 'https://nfse-videira.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
        consultaRps: 'https://nfse-videira.atende.net/atende.php?pg=rest&service=WNERestServiceNFSe&cidade=padrao',
