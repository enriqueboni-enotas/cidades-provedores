var jiraChangelogData = [
  ...
  },
  {
    ...
    itens: [
      {
        icon: '🏙️',
        destaque: 'Envio de IBS e CBS em Cotia/SP',
      ...
      {
        icon: '🔧',
        destaque: 'Alteração de painel para SMU — Araraquara/SP',
  ...
  },
  {
    ...
    itens: [
      ...
      {
        icon: '🔧',
        destaque: 'Vendas não importadas no emissor',
  ...
  },
  {
    ...
    itens: [
      ...
      {
        icon: '🌐',
        destaque: 'País não informado na emissão — Santos/SP e outros',
      ...
      {
        icon: '🔧',
        destaque: 'Informações complementares não exibidas na NF-e',
