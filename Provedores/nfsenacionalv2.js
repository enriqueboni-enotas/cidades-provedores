var provedorDetalhe = {
  ...
  visaoGeral: [
    ...
    { key: 'Total Municipios', val: '1860' },
    { key: 'Estados Atendidos', val: ['MG', 'SP', 'RS', 'BA', 'PR', 'GO', 'SC', 'PA', 'PI', 'RN', 'PB', 'MA', 'AL', 'CE', 'TO', 'PE', 'MT', 'RJ', 'ES', 'MS', 'RO', 'SE', 'AM', 'RR', 'AC', 'AP'], type: 'uf-badges' }
  ],
  ...
  municipiosLista: {
    'nfsenacionalv2': [
      ...
      { nome: 'Rio da Conceição', uf: 'TO', ibge: '1718659' },
