 ...
 */
var ACCESS_LOG_URL =
  'https://script.google.com/macros/s/AKfycbx_qYKBYcBuU69NfXmm4PByiKPVDLjGhL-m2c4QDYTkvrm57V-sSJ_Zz15bhWqD9sm4VA/exec';
...
(function () {
  ...
  function createOverlay(errorMsg) {
    ...
    var _authAssetsBase = '/cidades-provedores/';
    overlay.innerHTML =
      '<div class="auth-box">' +
      '<div class="auth-logo"><img src="' +
      _authAssetsBase +
      'assets/hotmart-logo.svg" alt="Hotmart" style="height:32px;width:auto"><span style="color:#E0DED8;font-size:20px;margin:0 12px">|</span><img src="' +
      _authAssetsBase +
      'assets/enotas-logo.png" alt="eNotas" style="height:24px;width:auto"></div>' +
      '<div class="auth-title">Cidades & Provedores</div>' +
      '<div class="auth-subtitle">Base de conhecimento do eNotas Gateway.<br>Faça login com sua conta <strong>@hotmart.com</strong> para acessar.</div>' +
      ...
      'Entrar com Google</a>' +
      (errorMsg
        ? '<div class="auth-error" style="display:block">' + errorMsg + '</div>'
        : '') +
      '</div>';
  ...
  // ── Init ──
  function init() {
    // Bypass auth quando rodando localmente (file:// ou localhost)
